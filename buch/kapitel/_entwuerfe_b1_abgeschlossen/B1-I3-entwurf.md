...
## Historische Rahmenbedingungen (154 TZ ≈ 1423 AD-Äquivalent)

- Keine Gaslampen, kein Strom — Talgkerzen, Öl, Fackeln
- Keine Druckpresse — Manuskripte handgeschrieben
- Anrede: Ihr/Euch (kein Sie) — Maße: Schritt, Elle, Klafter — Monate: Nebelmond, Frostmond
...
**Beats:**
1. Drei Wochen zurück: Lene hat einen Schemen auf dem Klippenweg gesehen, mitten am Tag, reglos zwischen den Felsen, den Kopf in ihre Richtung gedreht. Zwei Wochen zurück: Keldan hat am Hafen sieben gezählt, mehr als je zuvor an einem Abend. Letzte Woche: der Schemen der Elke am Klippenrand verfolgte, keine Tier-Form mehr — aufrecht, schmal, gezielt. Die Qualität der Bedrohung hat sich verändert.
...
3. Kesper klopft. Zwei Knöchel, kurz. Elke kennt das Klopfen. Er ist Maler, 34 Jahre, vor drei Wochen angekommen — der vierte. Die Hände dauerfleckig mit Pigmenten die nie ganz rausgehen. Sein letztes Bild: ein Hafen, Nacht, Hohlräume im Schatten, Augen. Er hat es dreimal abgekratzt. Es erschien wieder, dunkler.
...
5. **Schlussbild:** Durch das Fenster: drei Schemen, aufrecht, reglos. Kesper sagt: "Seit drei Stunden." Elke zieht den Vorhang zu.

**Dialog-Informationen:**
- Kesper erfährt: Elke hat das Raumgefühl am Steinkreis beschrieben — als würde etwas nachgeben, wenn alle vier gleichzeitig drücken
- Elke erfährt: Kesper hat sein letztes Bild fertig. Hat es Lene gegeben. "Für das Manuskript, das sie schreibt. Falls."
- Elkes Erkenntnis: Er rechnet damit, nicht zurückzukommen. Sie auch. Das ändert nichts.

**Tschechow-Waffen geladen:**
- Kesper gibt Lene das Bild → Lene zeichnet es im Manuskript nach dem Feuer → feuert in Buch 1 (Archiv, K09)
- Kespers Wahrnehmungs-Resonanz (passiv): Augen in Schatten, Bild das sich selbst schreibt → Spiegelung auf Sorel K10
- "Als würde der Raum nachgeben" — Elkes erste Beschreibung des Riss-Phänomens

**Tschechow-Waffen abgefeuert:**
- Schemen werden gezielter (I1: Tiere, I2: Beobachter, I3: verfolgen aktiv)
- Vier Resonanz-Träger alle in Vael (I2-Ende)

**Ausarbeitungs-Hinweis:**
- 2–3 sensorische Details die zeigen was Elke diese Nacht mit Kesper hat — kein Sex, aber Textur: Wärme, Geruch, wo er sitzt, wie er riecht wenn er schläft oder nicht schläft. Der Leser muss fühlen was sie verliert.
...
**Beats:**
1. Vor dem Morgengrauen: Feuer von der Hafenseite. Drei Feuer-Schemen treten durch eine Öffnung in der Luft — ~100m vom Steinkreis entfernt, östlicher Gartenteil. Varen hat sein Portal geöffnet, irgendwas durchgeschickt. Er weiß nicht was auf dieser Seite ist. Die Schemen richten Schaden an weil das ihr Auftrag ist — erkunden, nehmen Raum ein.
2. Die vier im Garten. Keldan tritt vor — hält einen Eisenarm als Schild. Lene und Kesper und Elke am Steinkreis: kein Ritual, keine Vorbereitung. Nur: JETZT, alle gleichzeitig, wie letzte Woche. Fester. Die Luft über dem Kreis fängt an zu flimmern.
3. **Keldans Tod:** Einer der Schemen dreht sich nach ihm. Das Eisen schmilzt. Keldan fällt. Steht nicht auf.
4. Das Flimmern bricht kurz ab ohne Keldan — Lene und Kesper und Elke drücken weiter. Das Flimmern kommt zurück, instabiler, zuckend. Dann: ein Riss. Nicht sauber — eine Wunde in der Luft des Gartens. Dahinter: anderes Licht. Zwei Monde. Für Sekunden. Dann schließt er sich wieder.
...
7. Kesper sagt: "Ich komme mit." Elke: kein Wort. Sie greifen gleichzeitig in den Riss.
8. **Kespers Tod im Übergang:** Der Riss schließt sich WÄHREND sie durchgehen. Instabil — er hält einen Atemzug zu kurz. Elke kommt durch. Kesper nicht. Was von ihm ankommt, ist nicht mehr Kesper.
...
- Kesper: "Ich komme mit." — kein Plan, keine Erklärung
- Elke: kein Wort — sie greift in den Riss
- Lene: Blick zu Elke, kurz. Beide wissen es.

**Tschechow-Waffen geladen:**
- Elke kann nicht zurück (Keldan tot, Kesper tot, braucht alle vier für Thalassien-Seite)
- Lene allein, verletzt → schreibt das Manuskript; Kespers Bild darin
...
- Kespers Ende IM Übergang → neue Art von Tod, die Elke nie verarbeiten kann (kein Leichnam, keine Stelle, kein Grab)
...
- Kespers Bild im Manuskript → Sorel erkennt es K10
...
- Kesper gibt Lene das Bild (Szene 1) → sie hat es noch
...
**Was weiß Lene am Ende:** Keldan tot. Kesper verschwunden — kein Leichnam. Elke durch den Riss. Sie ist allein. Die Phänomene haben aufgehört. Die Stadt schläft.

**Was darf Lene NICHT wissen (Sorel-Prinzip):**
- Ob Elke angekommen ist
- Was Kesper im Übergang passiert ist
...
## Canon-Stand nach diesem Entwurf
...
- Varens Motivation für das Portal-Experiment in I3 (Forschung? Ressourcen? Verbindung suchen?) — muss nicht in I3 aufgelöst werden.

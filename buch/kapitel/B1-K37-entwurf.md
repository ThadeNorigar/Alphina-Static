...
**Aktplan-Abweichung (begruendet):** Aktplan `05-akt4.md` Kap. 37 hat Sorel **lebend** in K37 (er „geht als Erster" durchs Tor; Schluss ist Tableau in Vael mit Tohl/Halvard). Status.json + Memory (2026-05-06 Session-Eintraege) haben den Plot revidiert: Sorel stirbt **in K37 Sz3** durch Varens Schutzschemen, K38 setzt mit Alphinas Schrei + Resonanz-Ausbruch ein. Aktplan ist outdated und muss bei Gelegenheit refactored werden — der Tohl/Halvard-Beat gehoert in den K40-Epilog. status.json fuehrt.
...
- **NORA** (Robert/Kennedy/Simone) — Macht-Asymmetrie (der Mann hat die Vier durch Bindungsmagie fixiert, Hand an Alphinas Kinn als Macht-Geste), Schaerfe der Konfrontation, morally grey Antagonist, Stille-vor-Eskalation als Reibungs-Kern.
...
Das Wesen reagiert in Sekunden-Bruchteilen. Ein einziger Klauen-Schlag, **von oben nach diagonal**. Klauen schneiden durch Hemd, durch Brustbein, **von Sorels rechter Schulter bis zur linken Hueftknochen**. Sorels Griff am Mantel-Aufschlag loest sich. Er faellt rueckwaerts, hart aufs Stein-Pflaster. Kein Schrei. Kein letzter Atem. **Im Moment, in dem er auf den Boden trifft, bricht Licht aus seiner Wunde.** Sein Resonanz-Ende, ungerichtet. Auf den Stein-Platten um ihn herum erscheint sein Gesicht — kurz, auf jeder hellen Flaeche. Auf Alphinas Wange. Auf den Klauen des Wesens. Dann verblassen die Bilder. Stille.

Runa sieht es aus drei Schritt Distanz. Sie kann nichts tun. Der Mann tritt einen Schritt zurueck, Hand vom Kinn Alphinas geloest. Alphinas Mund oeffnet sich. Das Kapitel endet, bevor der Schrei kommt.

**Dialog-Informationen:**
- *Tableau-Position:* Sorel vor Alphina, Maren neben Sorel, Vesper hinter ihnen. Plot-Beat aus status.json. Gruppen-Geometrie.
- *Bindungsmagie:* die Vier koennen sich nicht bewegen. Runa hat keinen Begriff dafuer — sie sieht: sie koennen nicht. Beat-Inhalt: ihre Augen blicken nicht starr, ihre Haltungen sind nicht bewusstlos — sie sind wach, aber gefangen. (Memory `project_b2_k01-k27_canon.md`: Velmar-Halsband ist B2-Variante, in K37 noch keine Halsbaender — nur Bindungsmagie als Hand-an-Kinn-Akt. Halsbaender kommen in B2.)
...
- *Bindungsmagie broeselt:* die Vier koennen sich wieder bewegen. Sorel zuerst — er steht vor Alphina, also die kuerzeste Bewegungsdistanz zum Mann.
...
**Cross-POV-Ankerpunkte:**
- K38 (Alphina, kommend): Schrei + Resonanz-Ausbruch, Brombeer-Ranken, Dornen schneiden Verbuendete. K37 endet **eine Sekunde vor K38-Beginn**. Naht-Disziplin: Alphinas Mund oeffnet sich (K37-Schluss), Schrei kommt heraus + Pflanzen brechen aus dem Boden (K38-Anfang).
- K30 (Sorel-POV): Schwur-Disziplin endet hier mit Sorels Tod. Bogen schliesst sich.

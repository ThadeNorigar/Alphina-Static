...
- *Maren-Anker beim Anmarsch:* drei Schritt vor Sz2-Beat — Runa sieht Marens hochgeschobenen Aermel und Daumen am Hammer-Riemen. K32-Echo (Maren-Arm-um-Schulter-und-wieder-weg). Beat-Inhalt: koerperlicher Beat, der den K32-Anker aktiviert, ohne ihn zu benennen. Maren weiss nicht, dass Runa sie sieht.
...
- *Runas Position — Reibungs-Beat (NORA-Finding):* drei Schritt Distanz zur Gruppe, auf der Schwelle. Sie kann nichts tun. Sub-Text: in K32 hat ihre Faust gegen ein Schemen-Wesen gegluht und es verglimmt — heute, drei Schritt entfernt, mit warmen Haenden, stirbt jemand vor ihr. Aktive Reibungs-Stelle: sie weiss um die Joran-Erfahrung, sie weiss um die Bleilettern-Halbmond-Magie, **sie hat kein Repertoire fuer dieses Wesen.** Stufe 3 trainiert, kein offensives Repertoire (Memory `pov/runa.md` Stufen-Tabelle). Druckerin-Klarsicht: sie sieht sofort, dass keine ihrer K32-Modi hier wirken. Beat-Inhalt: Lähmung als bewusster Befund, nicht als Schock-Bewegungslosigkeit.

...
**Gaensehaut-Moment:** Zwei Plot-Beats hintereinander. (1) Beim Aufprall Sorels bricht Licht aus seiner Wunde, kurz, dann verblasst es — sein letzter Lichtwurf, Resonanz-Ende ohne Steuerung. (2) Sekunden spaeter brechen schwarze Triebe durch organische Substanz im Moragh-Boden, Anti-Flora-Blueten oeffnen sich direkt aus Sorels Wundlinie (Form ohne Zwischenstufe).

**Ton-Referenz-Leseproben (fuer /ausarbeitung):**
- `buch/leseproben/28-sorel-tod-moment.md` — Hauptanker fuer Sz2/Sz3 (Tod aus null Distanz, Schrei, Resonanz-Ausbruch durch organische Substanz, Anti-Flora-Form, Verbuendeten-Verletzung). Probe ist v4-canon-konform — instant-Tod ohne Sakrament, Klauen-Schlag rechte Schulter zu linker Hueftknochen, Licht aus Wunde, schwarze Triebe durch Organik. Kuang-Disziplin (Tod ohne Sanitisierung) plus Yarros-Aftermath-Praezision. **Pflicht-Marker fuer /ausarbeitung-Subagenten (Plot-Korrekturen 2026-05-10):** Probe enthaelt zwei Beats, die in K38 GESTRICHEN sind — (1) Gesichts-Projektion auf hellen Flaechen → nur Lichtbruch aus Wunde + Verblassen, KEINE Gesichts-Manifestation. (2) Wirbelsaeulen-Wurzel + schwarz-rote Hand-Verfaerbung an Alphina → KEIN koerperlicher Schaden an Alphina, Schuld-Folge stattdessen (Verbuendeten-Verletzung + Sorels Koerper mit Anti-Flora ueberdeckt). Die Probe darf **nur fuer Schlag-Geometrie und Lichtbruch-Physik** als Ton-Anker verwendet werden, nicht fuer atmosphaerischen Rahmen.
...
- **KAYA** (Kuang/SenLinYu/Pierce Brown) — Tod als Beat ohne Sanitisierung, Koerper-unter-Druck, Magie-Kontrollverlust mit Folge (Verbuendeten-Verletzung, Sorels Koerper mit Anti-Flora ueberdeckt), Trauma-Koerper bei Alphina (Schock-Erregungs-Koerper-Reaktion auf Varens Halt, kein Wille). Hauptstimme fuer das ganze Kapitel.
...
- *Mann-Beschreibung aus Alphinas Sicht (Plot-Korrektur 2026-05-10):* dunkler Mantel, einen halben Kopf groesser als Sorel, graue Schlaefen, **optisch attraktiv**, **scharfer/durchdringender Blick**. Augenfarbe spezifisch (Memory `project_augenfarben_quellen_exposition.md`: Violett = stark Magie-begabt — Alphina sieht es ohne den Marker zu deuten). Aura: **hochintelligent und gefaehrlich**. Plot-Erkenntnis Alphinas in der Sekunde: **er ist verantwortlich** — nicht zufaelliger Beobachter, nicht Reisender. Empfangskomitee. Antagonist. Sub-Text fuer B2/B3-Bekehrungs-Bogen: optisch attraktiv ist Plot-relevant fuer die Schock-Erregungs-Koerper-Reaktion (sein Reiz triggert Marker, sie kann ihn nicht abstellen).
- *Schemen-Sichtung vor Fixierung (Plot-Korrektur 2026-05-10):* Vier sehen alle Wesen, **bevor** Varen sie fixiert. Pferdgrosser Schutzschemen (vier Arme, Klauen wie Schlachtmesser, schwarze Augen ohne Lid, Velmar-Bauart) plus zwei oder drei kniehohe vierbeinige Wesen (K30-Hafenangriff-Bauart). Alle Schemen **rauchen** (Energie-Emission an der Oberflaeche, Magie-System Z.625 ff.) und tragen **dunkel-violette Bindungs-Glyphen** an Stirn, Schultern, Handruecken (Varens Velmar-Bindungs-Signatur, Magie-System Z.667 ff.) — sichtbarer Marker, dass sie zu Varen gehoeren. Vier erfassen die Situation als Empfangskomitee. **Etwa zehn Sekunden Vorlauf** zwischen Riss-Durchgang und Varens Drei-Resonanzen-Wirkung — Zeit, die Lage zu lesen.
- *Bindungs-Glyphen aus Alphinas POV (MEIKE-Reparatur, Sorel-Prinzip):* Alphina sieht die Glyphen, kann sie aber **nicht institutionell deuten** (sie weiss nichts von Velmar-Bindung, von Bindungs-Personifikation). Pflicht-Kodierung fuer /ausarbeitung: Botaniker-Linse-Wording — „dunkle Muster, violett, wie Tinte unter die Haut gezogen" oder „feine Linien, die durch den Rauch leuchten". KEINE Begriffe wie „Bindungsrunen", „Velmar-Signatur", „Glyphen-Schule". Plot-Beat-Wichtigkeit: das institutionelle Wissen erwirbt sie erst in B2 — in K38 sieht sie das Bild ohne Vokabel.
- *Agency-Versuch in den 10 Sekunden Vorlauf (NORA-Reparatur):* die Vier versuchen ihre Resonanzen aufzurufen, sobald sie das Empfangskomitee erfassen — Probe-Magie als Reflex bei Welt-Schock. Sie spueren das Reservoir-Anschwellen (Quellen-Naehe-Bonus, `10-magie-system.md`), die Magie wuerde wirken. Dann setzt Varens Drei-Resonanzen-Wirkung ein und blockiert die Emission. **Sichtbarer Versuch + sichtbares Scheitern** — sie sind nicht passiv, sie werden gehalten. Plot-Beat-Wichtigkeit: Alphina-Agency-Anker, sie ist Akteurin nicht Zuschauerin.
...
- *Sprach-Wechsel-Sequenz (Plot-Korrektur 2026-05-10, Online-Anmerkung):*
  ...
  - **Disziplin-Pflicht (MEIKE-Reparatur):** die ganze Sprach-Wechsel-Sequenz **max drei kurze Saetze in der Prosa**. KEIN Erzaehler-Kommentar ueber die Seltenheit alter Thalassisch-Kenntnisse oder Welt-Geschichts-Exposition. Wenn /ausarbeitung den Wechsel atmosphaerisch auswalzt, kippt Sz1 zum Welt-Bau-Kapitel statt Bedrohungs-Kapitel.
- *Plot-festgelegte Wortlaut-Anker — Varens Begruessung (Plot-Korrektur 2026-05-10):*
  ...
  - **Wortlaut-Qualitaets-Anker (NORA-Reparatur):** Varens Saetze tragen drei Qualitaeten zugleich — **formell** (alter Sprach-Register), **leicht-dissonant** (Hoeflichkeit-an-falscher-Stelle, Charme-zu-glatt-fuer-Bedrohung), **zu-klug-fuer-die-Situation** (er rechnet mit, was die Vier denken werden). Plot-Pflicht fuer /ausarbeitung: ein einzelner Satz von Varen muss diese drei Qualitaeten zeigen — nicht als Wortlaut diktiert, aber als Register-Pflicht. Beispiel-Qualitaet: »Ihr seid willkommen, edle Reisende. Mein Garten erwartet Euch — vier feine Resonanz-Traeger, gleich vier auf einmal — welch Gluecksfall.« (Hoeflichkeit + Vereinnahmung + zu-klug). Wortlaut Beispiel, /ausarbeitung formuliert konkret.
...
- *Alphinas Runen-Wiedererkennung als Trigger (Plot-Korrektur 2026-05-10, Online-Anmerkung):*
  ...
  - **Agency-Koerper-Marker vor dem Aussprechen (NORA + MEIKE-Reparatur):** bevor Alphina den Satz formt, geschieht ein koerperlicher Beat — die Hand wird kalt, die Handflaeche oeffnet sich, das Handgelenks-Kribbeln gegen die Daempfung wird kurz schmerzhaft, **bevor die Stimme kommt**. Pflicht fuer /ausarbeitung: nicht Mut, nicht Entschluss, sondern Reflex ihres Koerpers vor der Stimme. Sonst wirkt die Anklage wie Plot-Faktum statt aktiver Akt.
  ...
  - **Takt zwischen Anklage und Antwort (KAYA-Reparatur):** zwischen Alphinas Satz und Varens Einfrier-Befehl muss ein **halber Atemzug Pause** liegen — Varen sieht sie an, neu-berechnet. Plot-Pflicht: kein direkter Schalter-Reflex, sondern sichtbarer Macht-Wechsel-Moment. Sonst wirkt Alphina wie Ausloese-Mechanismus, nicht wie Akteurin.
...
- *Was Alphina NICHT sieht (Sorel-Prinzip):* die exakte Bauart-Kategorie der Wesen (Velmar-Bauart, K30-Hafenangriff-Echo) — sie sieht die Wesen, deutet sie aber nicht institutionell. Das innere Vokabular der Schutzschemen-Auftrag-Reflex-Mechanik fehlt ihr (Memory `project_b2_k01-k27_canon.md`: Velmar-Wissen kommt erst B2).
...
Der Mann verliert fuer einen Atemzug die Konzentration; sein Blick verschiebt sich auf einen Punkt rechts hinter Alphina. Drei-Resonanzen-Wirkung broeselt. Alphina kann den Kopf langsam drehen, sieht den Schatten an der Schwelle. Runa kommt durch den Riss, bruellt beim Angriff — Alphina identifiziert sie an der Stimme. Sorel loest sich aus der Wirkung, schubst Varen mit physischer Wucht von Alphina weg (Hand-Kinn-Kontakt bricht). Setzt nach, will sich auf den Mann stuerzen. Der Schutzschemen reagiert in Sekunden-Bruchteilen, Klauen-Schlag rechte Schulter zu linker Hueftknochen — Sorel stirbt instant, faellt rueckwaerts. Beim Aufprall: Licht bricht kurz aus seiner Wunde, verblasst. Beat kippt am Ende: Stille, Sorel tot, Varen ausser Reichweite.
...
- *Sorel-Sprung — aktiver Angriff (Memory `pov/sorel.md` + Plot-Korrektur 2026-05-10):* nicht Defensiv-Schritt-falsch-gedeutet. **Er schubst Varen mit physischer Wucht von Alphina weg** (Hand-Kinn-Kontakt bricht — physische Trennung, Drei-Resonanzen-Wirkung an Alphina endgueltig gebrochen). Setzt nach, will sich auf den Mann stuerzen. Plot-Beat: K30-Schwur eingeloest („zwischen Welt und Alphina, immer"). Das ist der Moment, in dem der Schwur zu Tat wird. Plot-Wichtigkeit: Sorel ist kurzzeitig **erfolgreich** (Alphina ist frei, Varen ist weggeschubst) — dann kommt der Tod. Mehr Punch als reines Greifen.
...
- *Klauen-Schlag-Geometrie (Aktplan + Memory):* von oben nach diagonal, rechte Schulter zu linker Hueftknochen. Klauen schneiden durch Hemd, Brustbein, in den Brustkorb. Memory `project_schemen_magie_modi.md` (aktualisiert 2026-05-10): Schemen sind physisch manifest, scharfe Klauen schneiden physisch wie Mensch mit Klingen. Lautlosigkeit nur fuer Eigenbewegung; Welt-Kontakt erzeugt normales Geraeusch (Stoff reisst hoerbar, Knochen splittert).
- *Sorel stirbt instant (Memory: KAYA-Anker, Tic-Reduktion):* kein „halber Atemzug". Er faellt rueckwaerts auf den Stein-Boden. Brust hoert auf, sich zu heben. Kein Schrei. Kein letzter Atem.

- *Runa-Eintritt aus Alphinas POV (Plot-Korrektur 2026-05-10):* Alphina kann den Kopf langsam drehen, sobald Varens Blick wegrutscht und Sorel den Hand-Kontakt bricht. Sie sieht den Schatten an der Schwelle. Runa **bruellt beim Angriff** — Alphina identifiziert sie an der Stimme, nicht an der Sicht. Plot-Wichtigkeit: Cross-POV-Anker zu K37-Cliffhanger (dort: Runa „rennt umgehend auf Varen los"); K38 zeigt die Stimm-Identifikation aus Alphinas POV und gleichzeitig Runas Folge-Aktion (siehe Sz3 Runa-Schemen-Angriff).
...
- *Licht-Sequenz (Aktplan + Memory `feedback_resonanz_nicht_benennen.md`):*
  ...
  - **Licht verblasst kurz nach dem Aufprall.** Stein wird wieder Stein. Stille.
  - **Korrektur 2026-05-10:** Gesichts-Projektion auf hellen Flaechen (frueher in Aktplan + Leseprobe 28) ist GESTRICHEN. Kein Gesichts-Manifestations-Beat mehr. Licht ohne Gesicht.
  - **Konkretheit-Anker (MEIKE + KAYA-Reparatur):** Was sieht Alphina ausser dem Licht? Pflicht-Marker fuer /ausarbeitung — **ein konkreter Bild-Anker** (Stein-Platte unter Sorel, Blut auf ihrer Wange, Sorels Hand offen am Boden). Welcher von den drei wird in /ausarbeitung gewaehlt: ein, nicht alle. Lichtbruch + ein Bild-Anker + Verblassen = die drei Saetze.
  - **Verstehen ueber Koerper, nicht Innenrede (KAYA-Reparatur):** Alphina versteht intuitiv, dass das sein letzter Lichtwurf war (Resonanz-Ende). Pflicht-Marker: dieses Verstehen kommt **nicht als Gedanken-Satz**, sondern als Koerper-Beat (Knie weich, Haende kalt, Atem stockt). Die Deutung traegt sich durch den Koerper, nicht durch POV-Kognition. Kein „sie wusste, das war seine Resonanz" oder „sie verstand". Nur Koerper.
...
- *Was Alphina im Moment des Todes weiss (Plot-Schicht-Inhalt fuer /ausarbeitung):*
  ...
  - der Lichtbruch aus seiner Wunde ist sein letzter Lichtwurf.
...
Alphina schreit ohne Atempause: erst Schmerz-Schrei (hoch, duenn), dann Wut-Schrei (tief, rau), durchgehend. Wille dreifach gleichzeitig: den Mann toeten, Vesper/Maren/Runa schuetzen, Sorel retten. Resonanz-Ausbruch instant: schwarze, dornige Triebe wachsen durch organische Substanz unter dem Stein, brechen die Platten auf. Anti-Flora-Form (schwarz-Dornen + blut-roter Bluetensaum + Purpur-Staengel — Trauer-Manifestation, keine Knospe). Aus Sorels Wundlinie oeffnen sich Blueten direkt — der Heil-Wille trifft auf totes Substrat, das Wachstum kippt zu Anti-Flora. Parallel stuerzt sich Runa im Chaos auf einen der kniehohen Schemen, laesst ihn in Feuer aufgehen (chaotische Schock-Magie, K31-Echo Druckerei-Faust-Verglimmen). Welle Vegetation rollt: Dornen gegen den Mann (Toetungs-Wille), gleichzeitig waechst es um die Verbuendeten (Schutz-Wille, aber Koerper differenziert nicht — sie werden mitverletzt). Eine Dornen-Spitze trifft Varens Wange (erste Gesichtswunde seit Jahrzehnten), seine Schemen schlagen Bresche, er flieht blutend hindurch. Beat kippt am Ende: Varen weg, Schrei laeuft weiter, Pflanzen wachsen weiter — Wille bleibt aktiv, Koerper kann ihn nicht differenziert ausfuehren.

**Dialog-Informationen:**
- *Schrei (Aktplan-Anker, Tic-Reduktion KAYA-Linie):*
  - **Schmerz-Schrei zuerst:** hoch, duenn, ohne Worte.
  - **Wut-Schrei direkt anschliessend, ohne Atempause:** tief, rau, mit Ziel. Sie hat ihn nicht angefangen, sie kann ihn nicht beenden.
  - Schrei laeuft durchgehend — solange Varen auf dem Platz ist und auch danach. Treibt Resonanz-Ausbruch an.

- *Wille bei Resonanz-Ausbruch (Plot-Korrektur 2026-05-10):* Alphinas Wille ist dreifach gleichzeitig: (1) Varen toeten, (2) Vesper/Maren/Runa schuetzen, (3) Sorel retten/heilen. Sie unterscheidet bewusst, intendiert nichts gegen ihre Verbuendeten. **Aber:** ihr Koerper kann den Wille in dem Moment nicht differenziert ausfuehren. Folge:

- *Wille-Pflicht-Marker fuer /ausarbeitung (NORA-Reparatur):* mindestens **ein kurzer Koerper-Beat** muss zeigen, dass sie *will* schuetzen und *kann nicht*. Beispiel: Hand schiesst nach vorn um eine Ranke zurueckzuhalten, die auf Maren zueilt — Hand bleibt in der Luft, die Ranke geht durch. Oder: Blick zu Vesper, sie sieht ihn zurueckweichen, kann ihn nicht warnen. **Sonst kippt Sz3 zu reiner Rage** und der dreifache Wille bleibt nur auf dem Papier. Pflicht: Schutz-Wille muss spuerbar werden, mindestens einmal.
  - **Heil-Wille auf Sorel** trifft auf totes Substrat (Memory `project_alphina_zellwachstum.md`: tote Stoffe reagieren nicht), Wachstum kippt zu Anti-Flora-Blueten in der Wundlinie.
  - **Toetungs-Wille gegen Varen** wirkt teilweise (Dornen-Schwung trifft Wange), weil er lebendig ist und nahe genug.
  - **Schutz-Wille fuer Verbuendete** schlaegt fehl, weil Koerper-Reaktion ungerichtet ist und alles Lebendige um sie herum ergreift — Maren-Wade, Vesper-Schulter, Runa-Unterarm.
  - **„Nur aufbauen"-Grenze bricht** (Memory `pov/alphina.md`): ihr Wille umfasst Toetung, ihre Magie folgt — sie hat die Charakter-Grenze ueberschritten. Schuld-Folgen sind Verbuendeten-Verletzung und Sorels Koerper mit Anti-Flora ueberdeckt; KEIN eigener koerperlicher Schaden (Memory `feedback_kein_magie_kosten.md`: Thalassier zahlen keinen persoenlichen Preis).
  - Plot-Tragik: Wille ist gut + dreifach, Koerper kann nichts davon richtig umsetzen.
...
- *Schuld-Folge-Beats (kein eigener koerperlicher Schaden — Memory `feedback_kein_magie_kosten.md`):*
  - Verbuendeten-Verletzung (siehe naechster Block).
  - Sorels Koerper mit Anti-Flora ueberdeckt — Heil-Wille kippt zu Entstellung.
  - Bruch der „Nur aufbauen"-Grenze: lebenslange Selbstwahrnehmungs-Erschuetterung, kein Narben-Anker am Koerper. Plot-Beat-Wichtigkeit: was sie mit sich nach Moragh nimmt, ist Schuld + Erkenntnis ueber sich selbst, nicht eine sichtbare Wunde.
  - Plot-Beat-Korrektur 2026-05-10: frueheres Konzept „Wirbelsaeulen-Wurzel als Selbst-Verletzung" + „schwarz-rote Hand-Verfaerbung" gestrichen — nicht Canon-gedeckt, widerspricht der Magie-Kostenregel fuer Thalassier.
- *Runa-Schemen-Angriff (Plot-Korrektur 2026-05-10):* parallel zur Resonanz-Ausbruch-Sequenz Alphinas. Runa stuerzt sich auf einen der kniehohen vierbeinigen Schemen, faengt ihn mit der Hand-Waerme, **laesst ihn in Feuer aufgehen**. Stufe-3-Magie an der oberen Grenze, Schock-Adrenalin als Verstaerker. Plot-Echo K31 (Schemen-Faust-Verglimmen-in-der-Druckerei, Hand glueht weiss → Wesen verglimmt) in groesserer Skala. **Pflicht-Marker fuer /ausarbeitung: chaotisch beschrieben** — kein elegantes Beat-Schema, sondern unkontrolliert, ungerichtet, panisch. Runa hat in der Sekunde keinen Plan, der Koerper handelt vor dem Kopf. Plot-Wichtigkeit: zeigt die Vier auf Moragh-Boden mit voller Magie-Wirkung (Quellen-Naehe-Bonus aus `10-magie-system.md`); zeigt Runa als Aktiv-Magier, nicht nur Schock-Mitlaeufer.
...
- *Varen — Flucht-Beat (Aktplan-Anker, Memory):*
  ...
  - **Aktiver Rueckzug, nicht Flucht-Reflex** (KAYA + NORA + MEIKE-Reparatur): bevor er durch die Bresche geht, sagt er **einen kurzen Satz in altem Thalassisch**. Plot-Wortlaut-Anker (Pflicht-Inhalt fuer /ausarbeitung): »Ich hab Euch unterschaetzet, Jaehrlein. Wir finden uns wieder.« — alte -et-Endung, »Jaehrlein« als Diminutiv (Anker-konsistent zu Sz1), Hoeflichkeitsform »Euch«. Inhalt: Anerkennung + Wiedersehen-Ankuendigung. **Pflicht-Form: kurz, kalt, nicht-erklaerend** — kein Abschiedssatz, kein Antagonisten-Monolog, keine Drohung mit Pathos. Sein Gesicht traegt nicht Angst, nicht Flucht — Korrektur seiner Notiz. Er hat die Datenmenge bekommen, fuer die er gekommen war (Sub-Text fuer Leserin sichtbar, fuer Alphina nicht).
...
- *Welle laeuft weiter — Alphina kann nicht aufhoeren (Aktplan-Anker, KAYA-Pfad):*
  - Varen ist weg. Sorel ist tot. Schrei laeuft weiter, Pflanzen wachsen weiter.
  - Wille bleibt dreifach (Toeten/Schuetzen/Retten), Koerper fuehrt ihn weiter ungerichtet aus — eine Welle Vegetation rollt auf die drei anderen zu.
  - Plot-Beat-Wichtigkeit: das ist die Bruch-Stelle. Sie hat die Kontrolle verloren, nicht den Willen. Memory `pov/alphina.md` Z.33: „Diese Grenze bricht in B1-K38 (Sorel-Tod-Zorn) zum ersten Mal — und kostet sie eine schwarze Wurzel durch die eigene Wirbelsaeule."
- *Alphinas Innenbeat (Plot-Inhalt, kein Prosa-Vorgriff):*
  - sie weiss in einem Moment: sie will Varen toeten, die anderen schuetzen, Sorel zurueck.
  - was ihr Koerper tut: alles waechst, ungerichtet, traegt sie nicht.
  - der Schrei laeuft durchgehend, sie kann ihn nicht beenden — Koerper hoert nicht mehr auf den Willen.
...
- *Was Alphina NICHT weiss (Sorel-Prinzip, ueber alle Sub-Text-Beats):*
  ...
  - dass der Resonanz-Ausbruch ihre „Nur aufbauen"-Grenze bricht (sie wird das in B2-Bund-Training lernen, wenn die Bund-Meister „Verunreinigung" sagen).
...
Vesper kommt hinkend hinter Alphina. Hand auf ihre Schulter, wortlos — eigener Beat, kurzer Atemzug Stille (B3-K40-Sub-Vorlauf-Anker, erstes Vertrauens-Berueher zwischen den beiden). Dann setzt Vespers Zeit-Resonanz ein: Alphinas Atem verlangsamt, der Wut-Schrei wird zu langer Vibration, dann reisst der Atem ab. Maren parallel: kniet drei Schritt entfernt, Hand-flaechen auf Stein, **entzieht dem Boden im weiten Radius das Grundwasser** (Wasser-Modus „Entziehen", `pov/maren.md`-Modi-Tabelle). Wurzeln und Ranken erschlaffen, Vegetation welkt. Runa geht durch die schrumpfenden Pflanzen, packt Alphina von hinten, laesst Waerme durch (Glutmond-Training-Stufe-3, kein Brennen). Drei Worte, wieder und wieder, vor dem Schluss-Beat: »Ich bin da.« Schrei verstummt, Koerper hoert auf zu zittern, Wurzeln sinken zurueck. Alphina bricht zusammen, Runa faengt sie. Vesper kommt naeher, Maren zieht das Bein nach. Vier am Boden, einer tot. **Schluss-Bild als letzter Beat (Pflicht-Marker, nichts danach):** Auf Sorels Brust, aus der Wundlinie heraus, zwischen schwarzen Trieben, eine Bluete — schwarz, blut-roter Saum, Purpur-Staengel. Sie sinkt nicht in den Boden. Sie verdorrt nicht. Sie bleibt.

**Dialog-Informationen:**
- *Drei-Resonanzen-Beruhigung — Wer was tut (Aktplan-Anker, Memory):*
  - **Vesper Zeit-Resonanz:** auf Alphina selbst. Verlangsamt ihren Atem, ihre Bewegung, das Schreien. Ihr Schrei wird langgezogen, tief, fast nicht mehr menschlich. Dann reisst der Atem ab — sie kann nicht mehr in der gleichen Frequenz schreien. Plot-Beat: Vesper ist hinkend (Schulter-Wunde), geht trotzdem hinter sie. Hand auf Schulter. Wortlos. **Eigener Atemzug Stille zwischen Hand-Auflegen und Resonanz-Einsatz** (Beziehungs-Lektorin-Reparatur, B3-K40-Sub-Vorlauf-Anker — der erste Vertrauens-Berueher zwischen Alphina und Vesper, der in B3 zur Sub-Phase wird). /ausarbeitung-Pflicht: dieser Beat darf nicht ueberspielt werden, er traegt das B3-Echo.
  - **Maren Wasser-Entzug:** kniet drei Schritt entfernt (Wade-Wunde, sie kniet auf dem unverletzten Bein), Handflaechen auf Stein, entzieht Grundwasser im weiten Radius. Plot-Beat: Werft-Ruhe, sie schreit nicht, sie arbeitet. Die Wurzeln und Ranken erschlaffen. Memory `pov/maren.md` Modi-Tabelle: **Modus „Entziehen"** als fuenfter Modus kodifiziert 2026-05-10 (Steuern, Kochen, Vereisen, Hoeren, Entziehen). 30-60 Sek-Limit gilt analog. K38-Sz4 = erste sichtbare Anwendung in B1.
...
- *Plot-festgelegter Wortlaut-Anker — Runas drei Worte (Aktplan-Anker, Pflicht-Inhalt):*
  ...
  - **Reihenfolge-Pflicht (KAYA + MEIKE-Reparatur):** „Ich bin da."-Wiederholung **endet bevor das Schluss-Bild kommt**. Der letzte Beat ist die Anti-Flora-Bluete auf Sorels Brust, **nicht** Runas Worte. Wenn /ausarbeitung die Wiederholung uebers Schluss-Bild trägt, wird das Bild ueberlagert. Pflicht: Worte abschliessen, dann Stille, dann Bild.
...
- *Schluss-Bild — Aktplan-Anker (Pflicht-Inhalt):*
  ...
  - **Schluss-Bild-Rhythmus (KAYA-Reparatur, Pflicht):** explizite Sequenz fuer /ausarbeitung — (1) **kurz** Vesper, Maren, Runa als Halbsatz oder Aufzaehlung (drei Koerper am Boden, lebendig); (2) **Schnitt** auf Sorel (kurzer Satz, der den toten Koerper benennt); (3) **Bluete als letzter Satz, allein** — ein Satz, kein Anhang, keine Reflexion. Wenn /ausarbeitung Schritt 1 zu lang traegt (Vesper-Hinken + Maren-Wade-Nachziehen ausschmueckt), wird das Bild matt bevor die Bluete kommt. Pflicht-Rhythmus: kurz, Schnitt, Bild.
...
- *Was Alphina am Ende von K38 weiss:*
  ...
  - sie hat ihre Verbuendeten verletzt und Sorels Koerper mit Anti-Flora ueberdeckt. Sie hat Angst vor sich selbst (Schuld + Bruch der „Nur aufbauen"-Grenze, kein koerperlicher Schaden).
...
- **Alphina hat Angst vor dem eigenen Wachstums-Bruch** (NEU K38) — Tschechow fuer B2-Bund-Training (Bund-Meister „Verunreinigung", Alphina erinnert sich an die K38-Anti-Flora-Welle und die Verbuendeten-Verletzung) und B3-Akt-IV-Duell (Verzweiflung ueber zwei Tage anhaltend wirkfähig — Memory `pov/alphina.md`).
...
- ihre Magie kann zerstoeren — sie hat Verbuendete verletzt und Sorels Koerper entstellt. Sie hat Angst vor sich selbst (Bruch der Charakter-Grenze, kein koerperlicher Schaden an ihr).
...
- Plot-Inhalt darf NICHT gekuerzt werden: Sorel-Tod-Geometrie, Licht-Sequenz, Anti-Flora-Bluete-Schluss, Runa-Schemen-Angriff.

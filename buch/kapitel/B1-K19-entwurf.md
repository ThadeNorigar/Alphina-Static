...
- Alphina erfährt: Vesper und Sorel kennen sich bereits (K18)
- Maren erfährt: Alphina (Name, Botanikerin, Pflanzenheilung, Steinkreis-Verbindung)
- Maren erfährt: Sorel (Name, Fotograf, Platten)
- Sorel erfährt: Maren (Name, Werft, Wasser). Er sieht, wie Vesper sie benennt — mit einer Sorgfalt die mehr ist als ein Vorname.
- Alle vier erfahren: sie sind nicht die Einzigen. Sie sind vier.

**Tschechow-Waffen geladen:** Der leere Garten (keine Schemen) → falsche Sicherheit vor dem Angriff
**Cross-POV-Anker:** K11 (Alphina+Vesper, erste Begegnung, "zwei Modi") → K19 jetzt vier Modi; K12 (Schemen auf der Mauer, beobachten still) → K19 Wächter-Schem greift an

---

## Szene 2 — Der Riss und der Kampf

**Wortziel:** 2.200–2.600 W
...
- Sorel erfährt: er kann Licht aktiv formen — nicht nur auf Platten, sondern im Raum
- Vesper erfährt: er kann zwei Frequenzen gleichzeitig halten. Das hat ihn etwas gekostet.
- Maren erfährt: sie ist verletzt, und niemand hat sie verlassen. Drei andere Menschen stehen zwischen ihr und dem Schem.
...
- Schemen-Angriff (K12, beobachtend) → Wächter-Schem greift an; die Beobachtungsphase ist vorbei
- Vespers 4:33-Frequenz (K03) → Riss-Öffnung dauert exakt drei Atemzüge: das Tor hat einen Takt

---

## Szene 3 — Die Skulptur

**Wortziel:** 1.200–1.400 W

Übrig: Wurzeln in der Luft. Die Form des Schemen — humanoid, drei bis vier Meter, die Arme leicht geöffnet — aus lebendigem Holz. Niemand hat sie gemeißelt.

[ALLE VIER] Sie stehen um die Skulptur herum. Erschöpfung, tiefe, körperliche. Maren blutet — Alphina legt die Hand auf die Wunde, ohne zu fragen, die Geste sitzt aus K12, sie weiß sie in den Händen. Alphinas Hände zittern dabei. Sorels Beine tragen ihn kaum. Vesper sitzt auf dem Boden, die Hände flach auf der Erde, als brauche er den Kontakt mit dem Untergrund.

Niemand spricht für eine lange Minute.
...
[ALPHINA-ANKER, Abschluss] Alphina schaut zurück. Einen Moment. Dann auf die Skulptur.

*"Wir müssen wissen, was das war."* Nicht als Frage — als die nächste Aufgabe.

**Dialog-Informationen:**
- Alle vier: gemeinsame körperliche Erfahrung (Erschöpfung, Heilung, Skulptur)
- Maren erfährt: Alphina heilt (an ihr, direkt)
- Alphina erfährt: Sorel zieht sie weg ohne zu fragen. Sie lässt es zu.
- Vesper's Erkenntnis: Das Muster ist vollständig. Vier Resonanzen, ein Ergebnis. Die Konsequenz ist jetzt Wissensarbeit.
- Sorel's Erkenntnis: Er hat sie beschützt, ohne gefragt zu werden. Sie hat es nicht abgewiesen.

**Tschechow-Waffen geladen:**
- Skulptur als Haron-Symbolblatt-Echo → K20: Maren erkennt die Steinkreis-Zeichnung in Harons Papier
- Wärmerer Stein nach dem Kampf → der Riss hat geantwortet; das Tor ist näher als vorher
- "Wir müssen wissen was das war" → Alphina initiiert die Nachforschungs-Phase (K20: Archiv)
- Das Wohlgefühl der Macht → wird sie in Moragh unvorsichtig machen (Tschechow, Buch 2)

---

## Kontinuitäts-Notizen

**Was wissen alle vier am Anfang von K19?**
- Vesper: kennt alle drei (K14/K17 Maren, K11 Alphina, K18 Sorel). Hat das Treffen arrangiert.
- Alphina: kennt Vesper (K11), kennt Sorel (K12/K13). Kennt Maren nicht.
- Sorel: kennt Alphina (K12/K13). Kennt Vesper (K18). Kennt Maren nicht.
- Maren: kennt Vesper (K14/K17). Kennt Alphina und Sorel nicht.
...
**POV-Eigenheiten im Kampf (für die Ausarbeitung):**
- Alphina sieht den Wald durch den Riss: Botanikerin, Pflanzen, Wachstumsdruck
- Sorel sieht das Licht falsch brechen: Fotograf, Brechungsindex, das Bild stimmt nicht
- Vesper spürt die Frequenz: Uhrmacher, falscher Takt, der Schem ist außerhalb des Systems
- Maren sieht den Schlag kommen, aber zu spät: Werftarbeiterin, Reaktion auf Gewicht und Bewegung

**Welches Wissen darf niemand haben (Sorel-Prinzip)?**
- Wer Varen ist (niemand kennt noch seinen Namen oder seine Rolle)
- Dass der Wächter-Schem von Varen kontrolliert wird
- Dass das Tor sich öffnet wenn alle vier zusammen sind (das ist die Konsequenz, aber keiner denkt sie noch)
- Dass Sorels Beschützer-Reflex sein Tod sein wird

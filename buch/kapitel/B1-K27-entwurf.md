...
- Heat-Level: explizit BDSM auf der Ebene von Power-Exchange. Szene 3 enthält angewiesenen Vollauszug (Maren nackt auf Anweisung, mit geschlossenen Augen), sanfte Ganzkörperberührung (Arme, Schultern, Rücken entlang) und einen einzelnen kurzen Schamhügel-Beat (Fingerspitzen zweier Finger offen, nicht abtauchend) mit explizitem Aufschub (*„Heute noch Geduld"*). **Keine Sexszene, kein Orgasmus, keine Vulva, keine Klitoris, kein Eindringen, keine Brust, keine Schenkel-Innenseiten.** Das Kapitel endet, bevor ein Bett betreten wird — Maren schläft auf der Wohnzimmer-Matte, zugedeckt mit der Wolldecke und obendrauf Vespers Gehrock.
- Keine Werft-Atmosphäre. Die Wohnung ist ihre Kajüte, nicht ihre Arbeit. Materialdichte dosiert: Lärche, Leinen, Wolle, Messing, Lampenöl, Tintenharz — 1–2×/Kapitel, nie gehäuft.

---

## Szene 1 — Die leere Wohnung, das Wörterbuch, die Hand

**Wortziel:** 1.200–1.400 W

**Ort:** Marens Wohnung, Arbeitsraum (Wohnzimmer), der lange Tisch, an dem K26 stattfand. 26. Blütenmond 551 TZ, kurz nach Mitternacht-Nähe. Von den sechs Öllampen, die Maren für das Treffen in Dosierung auf Tisch und Sims gestellt hatte (K26-Canon), brennen jetzt noch vier — zwei auf dem Tisch, zwei auf dem Sims; die zwei am Kamin sind zuerst heruntergebrannt. Keine Kerzen — Marens Wohnung ist auf Öllampen eingerichtet, wie die meisten Werft-nahen Haushalte in Vael. Draußen Hafengasse — Schritte eines Nachtwächters zweimal weit weg, sonst still. Die Tür ist noch warm von Alphinas Hand am Drücker. Auf dem Tisch: Harons Wörterbuch, aufgeschlagen an der Seite, an der sie in K26 aufgehört haben (fünf Wörter gefunden: *Kreis, öffnen, gemeinsam, vier, Heimat*). Daneben das Blatt mit den Ritualanweisungen aus dem Archiv. Humpen — zwei, nicht vier. Zwei Bleistifte und ein dritter für Korrektur. Ein Papierbogen mit den heutigen Notizen. Der Glaszylinder mit dem Blatt aus der Werft steht weiter am Mitteltisch. Am Fenster der Messingkompass. Kamin fast aus, Restglut.

**Beats (sachliches Exposé, Maren-POV):**

- Die Tür fällt ins Schloss. Maren hört Alphinas und Sorels Schritte auf der Gasse verklingen — zuerst gleichmäßig, dann verschluckt vom Wind Richtung Hafen. Sie bleibt einen Moment an der Tür stehen, die Hand am Drücker, um den Rest Wärme aufzunehmen, den Alphinas Handfläche dort hinterlassen hat. Sie merkt das, ohne dass sie es zuvor gewollt hätte. Sie lässt die Hand sinken.
- Sie kehrt an den Tisch zurück. Vesper sitzt noch so, wie sie ihn zuletzt gesehen hat: Rocktasche links, wo der Schachturm liegt, Harons Wörterbuch vor ihm auf der Fläche. Er hat die Handflächen rechts und links neben das Buch gelegt, flach, die Finger leicht gespreizt, bereit.
...
- **Innerer Beat — Maren:** Sie denkt, dass sie seit Solha mit keinem Mann an einem Tisch gesessen hat, bei dem ihre Hände nicht von selbst eine Aufgabe gefunden hätten — ein Glas rücken, einen Zettel glattstreichen, den Docht einer Öllampe mit dem Nagel kürzen. Jetzt finden sie keine. Der Bleistift liegt zwischen Daumen und Zeigefinger der Rechten, aber er bewegt sich nicht. Die Hand ist geformt wie für die Arbeit und wartet. Das ist Werft-Haltung — bereit und ohne Auftrag.
...
- **K24** (*Harons Wörterbuch*) — weitere Seite, sechstes Wort.
- **K26** (*„Bleib noch."* und die Vorbereitung des Tisches mit Wörterbuch, Bleistiften, zwei Humpen) — nahtlos fortgesetzt. Maren-POV holt das Bild aus Vesper-POV ein.
- **K20** (*Harons Papier, Intelligenz als Dienstleistung*) — Marens dekodierende Arbeit ist Fortsetzung des V/M-Musters: sie denkt mit, sie dient mit dem Kopf.

**Cross-POV-Ankerpunkte:**
- **K26 (Vesper-POV, Schluss):** Maren schiebt Harons Wörterbuch auf die Mitte, räumt Humpen weg außer zwei, zwei Bleistifte + ein Korrekturbleistift. *„Bleib noch."* — Feststellung. Vesper bleibt, streift den Schachturm, legt das Wörterbuch vor sich.
  **K27 (Maren-POV, Szene 1):** Dasselbe Bild aus ihrer Sicht. Sie formuliert *„Bleib noch."* nicht noch einmal — das wäre Dopplung. Stattdessen: die Tür fällt zu, sie kehrt zurück, setzt sich diesmal *neben* ihn, nicht gegenüber. Die Körper-Geometrie ist der Beleg, nicht die Wiederholung des Satzes.
- **K25 (Alphina-POV):** Alphinas Körperwärme (Runa, dann Maren in K26 im Mieder-Zuknüpfen-Moment). Hier: Warme Stelle am Drücker, die Maren beim Zurückgehen zum Tisch spürt. Kein Benannt-Werden, nur Wahrnehmung.
- **K18 / K26 (Vesper-POV, Schachturm):** Vesper streift den Schachturm in Szene 1, kalt. Maren sieht es nicht. Kein Meta-Kommentar — das Register bleibt bei ihr.
- **Sprach-Register Maren:** Satz ~25–40 Wörter, fließend, koordinierend. Lieblingswörter *stetig, gleichmäßig, satt, warm, dicht, eng*. Werft-Vokabular nur als Haltungs-Metapher (*„die Hand bereit, nichts zu tun"* = Werft-Haltung), nicht als Material-Katalog (kein Kiel, kein Hobel in dieser Szene).
- **Kleidung:** Privat-Register — Wollrock eng an der Hüfte, Mieder hält die Taille, Leinenhemd darunter. Am linken Handgelenk Lederriemen. Keine *„Jacke"*. Vesper: Gehrock, Weste, Leinenhemd, Rocktasche mit Schachturm.

---

## Szene 2 — Die stille Stunde

**Wortziel:** 1.800–2.100 W

**Ort:** Derselbe Tisch, dieselbe Nacht, später. Von den vier Öllampen, die zu Beginn von Szene 1 noch brannten, sind zwei im Lauf der Arbeit ausgegangen — Maren hat sie nicht nachgefüllt. Die beiden anderen brennen noch, niedrig — eine auf dem Tisch direkt neben dem Wörterbuch, eine auf dem Sims. Es wird dunkler im Raum. Die Fläche, auf der sie arbeiten, ist ein schmaler Kreis aus Licht um das Wörterbuch. Der Rest des Raumes geht in Grauschatten über. Der Kompass am Fenster ist nicht mehr zu sehen. Draußen still.

**Beats (sachliches Exposé, Maren-POV):**

- Vesper nimmt die Hand von ihrer Schulter nicht weg, um die Hand zu setzen, sondern um Platz zu schaffen. Er sagt: *„Leg die Hände flach auf den Tisch, wo das Buch liegt."* Es ist kein Angebot und keine Bitte, nur die Anweisung, ruhig gesagt, ohne *„wenn du magst"*.
...
- Sie bleibt sitzen, sie schweigt. Der Atem geht von selbst — erst flach aus der Brust, dann nach einer Weile tiefer, von unten her. Sie merkt, dass sie seit Mittag nicht so tief geatmet hat.
- Vesper setzt sich nicht neben sie, er tritt hinter ihren Stuhl. Sie hört ihn durch den Stoff seiner Weste hinter sich atmen. Er berührt sie nicht, obwohl er näher steht als in K19 je.
- **Die Hände.** Sie merkt ihre Hände zum ersten Mal seit Solha als still. Maren-Hände sind nie still; sie wischen, sie tasten, sie prüfen Maserungen, sie drehen Bleistifte, sie ziehen Lederriemen fest. Jetzt liegen sie auf Holz. Die Fingerkuppen fühlen die Maserung der Tischplatte — gleichmäßig, Lärche, alt, das Holz ruht durch und durch.
- **Der Kopf.** Ihr Kopf hat Abends immer eine Liste gehabt — Flut, Wind, Pech, Leim, was morgen kommt, Edric, die drei Spanten der Mittelhecke. Seit Vael sind andere Dinge dazugekommen, die sich nicht so ordentlich abhaken lassen: die Fingerabdrücke auf Harons Blatt, Lenes Zeichnung des Feuer-Wesens, die Patienten bei Halvard, die Frage um Runa, und vor allem die Frage, was auf der anderen Seite auf sie wartet, wenn sie durchs Tor gehen. Die Liste läuft in ihr jeden Abend bis sie schlafen geht, und schlafen geht sie spät, weil die Liste nicht aufhört. Die Liste hört jetzt auf. Nicht weil sie sie abhakt — weil sie keinen Zugriff mehr auf sie hat. Vesper gibt ihr wenig Bewegungsspielraum, und in diesem wenigen Spielraum ist kein Platz für die Liste.
- **Gänsehaut-Moment.** In der Stille, in der ihre Liste aus ist und ihre Hände liegen und ihr Atem tief ist, bemerkt sie ein Pochen. Nicht durch den Boden — sie sitzt, der Fuß ist nicht am Grund. In ihrem Brustkorb, zwischen Herz und Magen, etwas Stetiges. Zu langsam für ihren Herzschlag (sie fühlt ihren Herzschlag am Hals, anders, schneller). Zu regelmäßig für die Grauwe, deren Wellen immer zwei Takte lang sind und dann einen ausgelassen. Das hier ist eins, eins, eins. Ein Takt, der ihr fremd und vertraut zugleich war.
- Sie weiß sofort: das hat sie vorher schon gespürt. In der Werft, in der Kajüte, am Steg. Immer, wenn sie gedacht hatte, die Grauwe läuft rückwärts. Sie hat es weggedrückt, weil Werft-Hände nicht *hören,* sondern *tun.* Jetzt hat sie nichts zu tun, nichts zu drücken. Jetzt hört sie. Es ist da. Es ist in ihr. Es geht durch sie hindurch und antwortet auf etwas draußen — beides zugleich.
...
- Vesper merkt an ihrem Atem, dass etwas passiert ist. Ihr Ausatmen wird einmal zu lang. Die Schultern sinken, ohne dass sie sie sinken lässt. Er berührt sie immer noch nicht. Er sagt nach einer Pause, in der er sie hat ankommen lassen: *„Gut."*
- **Das Wort „Gut"** landet bei ihr nicht im Kopf. Es landet an der Stelle, an der sie gerade war — zwischen Herz und Magen, wo der fremde Takt saß. Das Mieder wird enger. Ihre Kehle wird trocken. Ihre Schultern bleiben unten.
- **Innerer Satz (Réage-Körper-vor-Kopf, darf benannt werden weil es Selbsterkenntnis ist):** *Hier durfte sie sein.* Nicht als Gedanke, der reift — als Feststellung, die plötzlich da ist, fertig, nicht vor einer Sekunde noch ausformuliert. Eine Erkenntnis ohne Vorwort.
...
- *Maren erfährt:* Vesper berührt sie nicht während der stillen Stunde. Die Präsenz ist das Werkzeug, nicht der Griff. (Réage: Dom-Stimme als Funktion.)
- *Maren erfährt (Gänsehaut):* Das Pochen, das sie als Werft-Phantom abgetan hat, ist in ihrem Körper, nicht im Stein. Es hat einen fremden Takt. Sie hat es vorher schon gespürt, aber nie zugelassen. Sie ordnet es nicht ein — sie hört es zu.
- *Vesper lernt (durch ihren Atem sichtbar):* Sie folgt nicht aus Pflicht, sie folgt, weil ihr Kopf es will. Er kann ihr Stille geben, und sie bleibt. Das hat sie in K20 noch nicht gekonnt (dort hat sie *„Gut"* als Körper-Eskalation erlebt; hier ist es Körper-*Ruhe*).
- *Maren-Kernsatz (Selbsterkenntnis-Label zulässig):* *„Hier durfte sie sein."*
- *Vesper-Satz als Ende-Geste:* *„Du darfst die Hände nehmen."* Nicht Befehl, Erlaubnis.
...
- **K20 Körperreaktion auf *„Gut"* (Mieder, Mund, Schenkel)** — hier fortgesetzt und verfeinert: *„Gut"* landet im Mieder, im Mund, aber nicht in den Schenkeln — die Szene ist oberhalb der Hüfte. Kein Eskalations-Bruch.
- **Marens weggedrücktes Körper-Wissen um die Wasser-Resonanz (Wissensstand-Dossier: *„Körper weiß es, Verstand drückt es weg"*)** — hier zum ersten Mal nicht weggedrückt. Bogen: von Wegdrücken zu Hinhören.
- **K24 Schock (Lenes Skizze, Fingerabdrücke)** — als Teil ihrer Abend-Liste erwähnt, die jetzt verstummt. Zeigt: der Horror ist Alltag geworden, er rangiert hinter anderer Dringlichkeit.

**Cross-POV-Ankerpunkte:**
- **K19 (Maren-POV, Hand auf Schulter mit Verband):** Ausdrücklich im Kontrast zu Szene 1 formuliert — im Entwurf-Kopf der Szene 1 bereits verankert. Erzähler darf in Maren-POV den Vergleich benennen (sie selbst denkt ihn, *„das ist nicht K19"* als interner Beat), weil sie die Szene selbst erlebt hat.
...
**Ort:** Derselbe Raum, eine unbestimmte Zeit später. Die Arbeit am Wörterbuch ist beendet. Von den sechs Öllampen des Abends ist nur die letzte übrig geblieben — sie brennt niedrig auf dem Sims, der Docht schon im Öl. Die anderen sind im Lauf der Nacht ausgegangen, nicht von Vesper gelöscht, nur heruntergebrannt. Der Raum ist fast dunkel. Auf dem Wohnzimmer-Boden zwischen Tisch und Kamin liegt eine dicke Flechtmatte, handgebunden, Hanfseile und Wolle eingezogen — eine Werft-Matte, nicht teuer, aber dicht und satt, warm durch das Wollgewebe. Maren hat sie seit Solha; sie hat sie in dieser Wohnung öfter unter sich als das Bett in der Kammer.
...
- Er greift in die linke Rocktasche und holt eine Figur heraus — dunkles Holz, hüfthoch-knapp für seine Handfläche, oben gezahnt wie eine kleine Zinne. Er stellt sie aufrecht auf den Tisch, unmittelbar neben das Wörterbuch, und lässt sie dort stehen. Er erklärt nichts. Maren hat die Figur nie zuvor gesehen; sie versteht die Geste trotzdem, weil er sie mit derselben Ruhe ausführt, mit der er vorhin die Hand auf ihrer Schulter nicht weggenommen hat. Die Figur steht, und was jetzt kommt, gehört zu ihr und ist etwas anderes als das, was vorher war.
...
- **Der untere Beat.** Er tritt um sie herum nach vorn; sie spürt ihn vor sich, ohne ihn zu sehen. Er legt die Handfläche einen Augenblick flach auf ihren Unterbauch, knapp über der Haarlinie, nur um den Ort anzukündigen. Dann, sehr langsam, fährt er mit den Fingerspitzen zweier Finger über den Schamhügel — einmal, offen, ohne abzutauchen, ohne zu drücken. Die Berührung ist so leicht, dass sie eher eine Linie ist als ein Griff; der Haaransatz gibt unter den Fingerkuppen nach. Maren-Reaktion: ihr Atem hält einen Schlag still, dann geht er weiter. Die Knie bleiben zusammen, der Rücken bleibt gerade, der Mund wird trocken. Sie bewegt sich nicht.
- Er sagt, ruhig und in demselben Ton, in dem er ihr vorhin *„Gut"* gesagt hat, nur mit einem Wort mehr: *„Braves Mädchen. Heute noch Geduld."* Zwei Sätze, die zusammengehören — Lob für das, was war, Aufschub für das, was noch nicht ist. Maren versteht beides ohne Übersetzung.
- Er nimmt die Hand vom Unterbauch weg; die Wärme bleibt einen Augenblick als Form, bevor sie in die allgemeine Kühle übergeht. Er sagt, dass sie die Augen öffnen darf. Sie öffnet sie. Der Raum ist fast dunkel; sie sieht die letzte Öllampe auf dem Sims, den engen Lichtkreis auf dem Tisch und ihre eigene Kleidung auf dem Stuhl. Vesper steht einen halben Schritt vor ihr, die Hände wieder an der Seite.
- Er sagt leise, dass sie sich jetzt auf die Matte am Kamin legen soll; er bringe ihr gleich die Decke und den Rock. Sie geht die drei Schritte, legt sich auf die rechte Seite, das Kissen unter dem Kopf, die Knie angezogen, immer noch ohne ein Stück Kleidung außer dem Lederriemen am Handgelenk. Die Flechtmatte ist warm unter der Haut, dicht und satt, wie Maren sie kennt.
- Vesper holt die Wolldecke aus der Kammer. Er deckt sie damit zu — Fußspitzen, Beine, Hüften, Bauch, bis unter die Schultern, gleichmäßig, ohne zu straffen. Dann zieht er seinen Gehrock aus, schüttelt ihn einmal kurz aus und legt ihn längs über die Decke, die Innenseite nach unten, sodass er auf der Höhe ihrer Schultern und des oberen Rückens zu liegen kommt.
- **Der Geruch.** Jetzt erst liegt ihr Gesicht nah genug am Stoff, dass sie ihn riecht. Leinen, gewaschen und lange getragen. Ein dunkler, ruhiger Tintengeruch — nicht frisch, eingezogen. Warmes Wachs, das bis in die Fasern geht. Und unter allem ein Geruch, der nur ihm gehört und für den sie kein Wort hat. Sie atmet einmal länger als sonst. Der Geruch bleibt.
...
- Vesper setzt sich an den Tisch, sie hört ihn sich niederlassen und die Seiten wenden. Die letzte Öllampe brennt noch einen Augenblick auf dem Sims und geht dann auch aus — aus Aktplan-Canon: er arbeitet im Dunkeln weiter, aus dem Gedächtnis.
- Sie schläft.
- **Nicht-gedachter Schluss-Beat (Maren-POV-typisch: nicht als Meditation, sondern als Feststellung):** Sie hat seit Solha mit keinem Mann geschlafen, der wach war und sie trotzdem meinte. Vesper arbeitet im Dunkeln, und sie schläft. Die Matte ist dicht. Der Gehrock ist warm. Das Pochen, das sie in Szene 2 gehört hat, ist immer noch da, aber sie trägt es jetzt nicht mehr allein durch den Abend. Es pocht, und sie schläft.
...
- *Berührungen kalibriert:* Arme, Schultern, Rücken entlang als ruhiger Care-Bogen. Als einzigen sexualisierten Moment: Fingerspitzen zweier Finger offen über den Schamhügel, nicht abtauchend, kein Griff, keine Vulva-Berührung, keine Klitoris, kein Eindringen. Diese eine Geste ist Dom-Aneignung plus expliziter Aufschub (*„Heute noch Geduld"*). Keine Brust, keine Schenkel-Innenseiten. K27 ist nicht die erste Sex-Szene (die kommt im nächsten V/M-Kapitel), K27 ist die erste Power-Nacht mit Versprechen auf später.
- *Vespers Lob-Aufschub-Satz:* *„Braves Mädchen. Heute noch Geduld."* — zwei Sätze, die zusammengehören. Lob für die vollendete Hingabe, Aufschub als Geschenk (nicht als Entzug). Réage-Dom-Grammatik: Kontrolle über Zeit und Zugang gehört dem Dom.
...
- **Marens *„nie bleiben"*-Motiv (POV-Dossier):** Hier gebrochen. Sie bleibt, sie schläft, sie wird morgen wieder aufwachen in derselben Wohnung, und Vesper wird gegangen sein oder noch da. Beides ist tragbar.

**Cross-POV-Ankerpunkte:**
- **K26 Schluss (Vesper-POV):** *„Er fängt an."* — in K27 aus Maren-POV: sie hört ihn arbeiten, dann schläft sie. Die beiden Schluss-Beats schließen sich zu einem Bild, ohne Dopplung.
- **K28 (Maren, drei Monate später):** Die Matte und der Boden sind dann schon Canon. Das rückwärts fließende Wasser zieht Maren nachts vom Werft-Boden (nicht vom Bett) zum Steinkreis. Die K27-Körper-Geographie (Boden, nicht Bett) wird in K28 zur Bewegungs-Grundlage.
- **B2 (Maren allein in Moragh):** Marens Erinnerung an Vespers Mantel über den Schultern. Der Gehrock ist in Moragh nicht dabei — sie trägt Moragh-Gewebe. Der Canon-Kontrast wird tragend.
...
- **Aus K26:**
  - Korrelation Vespers Drift / ihrer Gezeiten-Anomalien, Mittelpunkt Steinkreis. *(Sie versteht die Geometrie.)*
  - Halvards vier Patienten mit Schem-Fingerabdrücken. Eskalation Sichtung → Berührung → Versengung.
  - Runa ist wahrscheinlich Resonanz-Trägerin, nicht eingeweiht, Alphina hält Kontakt.
  - Fünf übersetzte Wörter aus Harons Wörterbuch: *Kreis, öffnen, gemeinsam, vier, Heimat/mein Ort.*
  - Aufteilung: V+M Sprache, A+S Resonanz. Durchgang danach (Zeitrahmen offen).
  - Lenes Ritual damals scheiterte, weil Keldan fiel. Alle vier gleichzeitig sind Pflicht.
  - Haron kam von drüben, sprach die fremde Sprache als Muttersprache.
  - Die Pflanze aus der Werft (K22) stammt aus derselben Quelle wie Moragh — Flora sickert mit.
- **Aus K24:** Archiv-Schock (Lenes Skizze des Feuer-Wesens, Schem-Fingerabdrücke auf Harons Blatt).
- **Aus K20:** Haron als Adoptivsohn der Dahls, TZ 544 Adoption. Er kam mit ~16 nach Vael. Das Ritual-Diagramm war seine Handschrift.
- **Aus K19:** Vesper legte Hand auf ihre Schulter, aber mit Verband-Vorwand (Daumen am Schlüsselbein, Pulsprüfung).
- **Aus K17 / K14 / ff.:** Vesper als Uhrmacher, Musterseher. Tidemoor-Uhr-Anomalie.
- **Aus K22 / K08:** Ihre eigene Wasser-Resonanz — *Körper weiß, Verstand drückt weg.* Sie hat das Pochen/die Rückwärts-Ströme wahrgenommen, aber nie benannt.
...
- **Den Namen Varen.**
- **Dass das Pochen das Tor ist.** Sie spürt es, sie ordnet es nicht ein. Keine Theorie, keine Hypothese, keine *„vielleicht ist das…"*-Formulierung.
- **Dass Haron Varens Agent war.** B2-Enthüllung.
- **Dass Sorel Varen auf den Platten erkannt hat.** K23-Canon, nicht geteilt.
- **Dass Runa eine Feuer-Resonanz hat.** K25-privat, nicht geteilt.
- **Dass Alphinas Körperwärme am Drücker Alphinas eigene Resonanz ist, nicht nur Temperatur.** Maren registriert, sie deutet nicht.

### Premature-Doubt-Check

- Maren zweifelt nicht an Vespers Hand, bevor die Hand da ist. Sie bemerkt sie und bleibt.
- Sie zweifelt nicht am Stillwerden, bevor sie still ist. Die Erkenntnis *„Kopf hört auf zu laufen"* kommt *nach* dem Stillwerden, nicht davor.
- Das Pochen wird *in* der Stille hörbar, nicht *vor* der Stille. Keine Ankündigung.
- Der Satz *„Hier durfte sie sein."* kommt *nach* Vespers *„Gut"*, nicht davor. Keine Vorahnung.

### Sprach-Register Maren (Check)

- Satzlänge 25–40 Wörter, fließend, selten brechend. Kein Stakkato außer bei Schock (nicht hier).
- Koordinierende Aufzählungen ohne Verb nutzbar: *„Holz und Leinen und Wolle."* Sparsam.
- Lieblingswörter aktiv: *stetig, gleichmäßig, satt, warm, dicht, eng, Lücke.* **Check in Ausarbeitung:** mindestens drei davon präsent.
- Wenig Konjunktiv. Innerer Widerstand formuliert sich als Feststellung.
- Kleidungs-Register: Privat — Wollrock, Mieder, Leinenhemd, Lederriemen am Handgelenk. Schlaf — Leinenhemd. **Keine Jacke.**
- **Kein Werft-Material-Katalog in dieser Szene.** Lärche (Tischplatte) einmal, Hanfseil/Wolle (Matte) einmal. Nicht mehr. Maren ist in ihrer Kajüte, nicht in der Werft.

### Kein Magie-Kosten / keine Spukgeschichte

- Das Pochen ist Marens eigene Wahrnehmung, keine Raum-Reaktion. Das Glas mit dem Blatt bewegt sich nicht. Die Öllampen-Flammen zucken nicht. Der Kompass dreht sich nicht. Keine Objekt-Reaktion.
- Maren zahlt keinen körperlichen Preis für das Hören. Sie ist müde von Arbeit, nicht von Magie. Canon: Thalassier zahlen keinen Preis.

### Heat-Kalibrierung (Positioning §3.3)

- Commercial BDSM Power-Exchange, **keine Sexszene**, kein Orgasmus. Szene 3: angewiesenes Vollausziehen, sanfte Ganzkörper-Berührung (Arme, Schultern, Rücken entlang) und ein einzelner kurzer Schamhügel-Beat (Fingerspitzen, offen, nicht abtauchend) mit explizitem Aufschub (*„Heute noch Geduld"*). Keine Vulva, keine Klitoris, kein Eindringen, keine Brust, keine Schenkel-Innenseiten. Das ist Réage-Register (Dom-Aneignung, Körper vor Kopf) plus Aufschub als Geschenk — die volle Sex-Szene wird im nächsten V/M-Kapitel platziert.
...
- Dom-Stimme als erklärte Funktion (Réage), in vollständigen Sätzen (nie Stakkato): *„Leg die Hände flach auf den Tisch, wo das Buch liegt."* — *„Du bleibst genau so sitzen und sprichst bis auf Weiteres nichts mehr."* — *„Gut."* — *„Du darfst die Hände nehmen."* — [Sz3 Ausziehen-Anweisungen] — *„Braves Mädchen. Heute noch Geduld."* — *„Ich bleibe noch eine Weile am Tisch sitzen. Falls du mich brauchst, bin ich da."* Funktionale Anweisungen, keine Erklärungen, keine Bitten.
...
- **Nicht wiederholt aus K26 (Vesper-POV):** *„Bleib noch."* wird nicht aus Maren-POV rückgesagt. Sie formuliert die Geste körperlich (Stuhl neben statt gegenüber).
- **Marens Nebel-Wort:** Falls Außenwelt durchscheint (Nachtwächter-Schritte draußen): Marens Register für Nacht-Luft ist *„dicht"* oder *„still"*, nicht *„Dunst"* (Sorel) oder *„bedeckt"* (Alphina).
- **Vesper-Register gefiltert durch Maren-POV:** Sie sieht seine Haltung (flache Hände auf dem Tisch), seine Rocktasche, seinen Gehrock, sein Leinenhemd. Kein *„Drift, Periode, Scheitel"* in Marens Kopf — das ist Vesper-Fachvokabular, nicht ihres.
- **Mantel statt Jacke** überall. Vesper trägt Gehrock, Weste, Leinenhemd. Keine Weste-Knöpfe gezählt (keine Uhrmacher-Präzision bei Maren).

### Commercial 95%-Gate-Check (Positioning §9) — Eröffnung Szene 1

1. **Erster Satz Hook:** *„Die Tür fiel ins Schloss."* plus Marens Hand am Drücker, um Alphinas Wärme aufzunehmen. Figur in Situation, Entscheidung beginnt.
2. **Figur will etwas:** Maren will, dass Vesper bleibt. Sie hat es in K26 gesagt. Sie handelt jetzt darauf hin (Humpen wegräumen, Stuhl neben ihn statt gegenüber).
3. **Etwas passiert in 200 Wörtern:** Sie geht zurück, setzt sich neben ihn — die neue Geometrie. Arbeit am Wörterbuch, gemeinsam gefunden: ein sechstes Wort.
4. **Körper im ersten Viertel:** Die Hand am Drücker (warme Stelle), der Stuhl näher an ihn, die rechte Schulter an seiner linken. Die Hand auf ihrer Schulter (Ende Szene 1). Alles körperlich, nicht emotional benannt.

### Horror-Kalibrierung

- Kein neuer Horror-Peak. Das Pochen ist Dark-Fantasy-Unterstrom, kein Schreckmoment. Maren zittert nicht, sie ist still. Der Horror kommt durch *Einordnung*, nicht durch Schauwert — und in diesem Kapitel wird nicht eingeordnet.
- Der K24-Grundton (Fingerabdrücke, Feuer-Wesen) ist im Hintergrund, als Teil der Abend-Liste, die heute verstummt.
...
- **⚑ Schachturm als V/M-Session-Signatur (NEU CANON ab K27):** Der Turm markiert die *volle* Session (Ausziehen + Körperzugang), nicht die kleinen Stillwerde-Anweisungen in Szene 2. In **Szene 3**, nachdem gemeinsam aufgeräumt ist und Vesper sich zurücklehnt, holt er den Turm aus der linken Rocktasche und stellt ihn aufrecht neben das Wörterbuch — *bevor* der erste Ausziehen-nahe Befehl kommt (*„Steh auf und stell dich drei Schritte vor den Tisch."*). Maren sieht es zum ersten Mal, kennt die Figur nicht, versteht die Geste aus der Ruhe heraus. Am Ende von Szene 3 (Aftercare-Ende), bevor Vesper sich wieder an den Tisch setzt, nimmt er den Turm vom Tisch und führt ihn in die Rocktasche zurück — Session-Ende-Marker. Maren sieht es durch die Wimpern. **Regel ab K27:** In allen künftigen V/M-Kapiteln ist der aufgestellte Turm auf dem Tisch/Sims/Kommode das sichtbare Zeichen, dass eine *volle* Session läuft. Der in der Tasche versteckte Turm bleibt privater Vesper-Anker (K18/K26-Canon wird nicht überschrieben). In der Ausarbeitung nicht metareflexiv (*„das wird sein Ritual werden"*) — nur zeigen, was Maren sieht.
...
- **Keine Sexszene:** Szene 2 endet mit Marens Händen im Schoß und Vespers *„Du darfst die Hände nehmen."* Szene 3 enthält Nacktheit und Berührung auf Anweisung; der einzige sexualisierte Moment ist der Schamhügel-Beat (Fingerspitzen, offen, nicht abtauchend) mit Aufschub-Satz *„Braves Mädchen. Heute noch Geduld."* Keine Vulva, keine Klitoris, kein Eindringen, kein Orgasmus. Die volle Sex-Szene wird im nächsten V/M-Kapitel gelegt.
- **Der Schamhügel-Beat präzise:** Er tritt um sie herum nach vorn, legt die Handfläche kurz flach auf den Unterbauch (nur Ortsankündigung), dann fährt er mit den Fingerspitzen *zweier* Finger einmal offen über den Schamhügel — keine Griffbewegung, kein Abtauchen, kein Drehen. Maren-Reaktion: Atem hält einen Schlag still, Knie bleiben zusammen, Mund trocken. Keine Anspannung, keine Welle — die Sub-Signatur bleibt Ruhe. Anatomie-Wort *„Schamhügel"* in der Ausarbeitung nur falls es trägt; ansonsten körperlich umschreiben (*„knapp über der Haarlinie"*, *„wo sich die Haare schließen"*). Kein *„Vulva"*, kein *„Muschi"*, kein *„Möse"* — nicht vulgär, nicht euphemistisch.
- **Zudecken-Reihenfolge:** Erst Wolldecke über den ganzen Körper (Füße bis unter die Schultern, gleichmäßig), dann Gehrock längs obendrauf (Innenseite nach unten). Der Gehrock kommt als letztes auf ihrem Rücken/Schultern zu liegen — so trägt ihr Gesicht nah am Stoff, und der Geruch (Leinen, Tinte, Wachs, der Geruch, der nur ihm gehört) landet direkt.

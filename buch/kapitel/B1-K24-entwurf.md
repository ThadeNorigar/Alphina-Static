...
Neu seit jenem Besuch: Esther hat die Schrift des Manuskripts mit einem kurzen Eigen-Vermerk von Lene im unbestimmten Bestand verglichen — eine Werft-Notiz mit Lenes Unterschrift. Dieselbe Kanzlei-Hand. Dieselbe Art, den Abstrich zu setzen. Die Autorin hier ist Lene Dahl selbst, keine spätere Kopistin. Jara schiebt den Vergleichsband halb auf, zeigt die Passage, legt ihn wieder weg.
...
**Dialog-Informationen:**
- Alphina erfährt: Esthers K20-Register-Fund komplett — Lene Dahl (TZ 151, Werftgründerin) → Linie bis Anen+Meren Dahl (letztes Paar, kinderlos) → Haron Dahl (TZ 544 adoptiert, Name bei Adoption angenommen). Die Dahl-Linie ist ein Namens-Erbe, nicht nur Blut. Haron ist kein gebürtiger Dahl. Neu seit K20: Esther hat die Manuskript-Handschrift mit einer Eigen-Notiz Lenes verglichen — dieselbe Hand, Lene selbst ist die Autorin. Maren selbst ist keine Dahl (Werfterbin ohne Blutslinie).

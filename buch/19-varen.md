...
**Name:** Varen. Keine Nachnamen, keine Titel, keine Kastenbezeichnung. Er trägt den Namen der Stadt die er getötet hat nicht — Mar-Keth trägt ihn nicht und er trägt sie nicht.
...
**Gefolgsleute:** Eine Handvoll Velmar-Deserteure, die seine Schuld kennen und trotzdem bei ihm bleiben — weil sie an die Wiedergutmachung glauben. Kein Heer, keine Armee. Er ist ein Einzelgänger mit einer kleinen Crew.
...
**Was er tat:** Drei benachbarte Quellen unter Mar-Keth zu einem Leylinien-Experiment verbunden. Er wollte Energie zwischen ihnen ausgleichen und die Gesamtkapazität erhöhen. Technisch: er hat die natürlichen Leylinien-Verbindungen zwischen drei Flözen künstlich verstärkt und dann Druck von außen aufgebaut, um die Fassungsgröße zu testen.

**Was geschah:** Das System schlug durch. Statt mehr Kapazität gab es eine Kettenreaktion. Eine Quelle kollabierte zuerst (Mar-Keth, die riesige). Der plötzliche Druckabfall riss die beiden gekoppelten Quellen mit (Dulrath-Ost und Reshkol). Innerhalb weniger Stunden waren drei Quellen tot — versiegelt, unwiederbringlich.

**Die Folgen:**
- **Mar-Keth (Riesig, Velmar-Kernstadt):** Varens Herkunftsstadt. ~120.000 Menschen. Größte Einzelkatastrophe. Die Stadt verdorrte innerhalb von Wochen. Wer konnte, floh. Der Rest starb an Erschöpfung — Magie-Regeneration unmöglich ohne Quelle, körperliche Arbeit ohne Magie-Unterstützung zu teuer. Heute: Ruinenstadt, Todzone, Unbewohnt.
- **Dulrath-Ost (Groß, Bund von Orath, nahe der Velmar-Grenze):** ~50.000 Menschen. Wurde in die Kettenreaktion hineingezogen, obwohl Bund-Gebiet. Handelsstadt verdorrte. Flüchtlinge nach Orath.
- **Reshkol (Groß, Velmar-Randgebiet, Grenze zu Orath):** ~50.000 Menschen. Velmar verlor ein Fünftel seiner Magiekapazität. Kastensystem verschärfte sich (Knappheit führt zu strengeren Bindungs-Regeln).

**Direkte Opfer:** ~200.000 Menschen heimatlos. Plus Tausende die in den Folgejahren starben. Plus alle Kriegstoten seit Kriegsbeginn — die sind indirekt auch seine Last, denn ohne den Quellen-Kollaps wäre der Krieg nicht ausgebrochen.

**Varen trägt eine Kleinnation auf seinem Rücken.**

---

## 4. Der Krieg — wie er tatsächlich ausbrach

**Wichtig:** Der Krieg brach **nicht** durch Schuldzuweisung aus. Niemand hat irgendjemandem die Schuld am Quellen-Kollaps gegeben. Keine Falschbeschuldigung. Kein "Velmar lenkt die Schuld auf die freien Städte". Das war mein falscher Vorschlag und wurde vom Autor explizit verworfen.

Was tatsächlich geschah: Die drei Quellen fehlten. Die verbleibenden reichten nicht für alle Menschen auf dem Plateau. **Das Vakuum reichte.** Fraktionen, die vorher koexistierten, begannen um Ressourcen zu kämpfen. Der Bund griff die Thar an, weil die Thar expandierten, um neue Quellen zu erschließen. Die Thar schlugen zurück. Velmar hielt sich raus — offiziell neutral, inoffiziell mitwissend. Der Krieg begann 1 MZ-Jahr nach dem Kollaps (MZ -4) und dauert inzwischen 4 MZ-Jahre.

**Varens Rolle im Krieg:** Nichts. Keiner. Er hat sich in die Grenzlande zurückgezogen, nachdem Velmar ihn ausgestoßen hatte, und forscht allein. Er führt keine Armee, er gehört zu keiner Seite, er plündert nicht. Er ist ein Schatten in Ruinen.

---

## 5. Velmar weiß und vertuscht

**Die Velmar-Binder-Elite weiß alles.** Varen war einer ihrer jüngsten und begabtesten Forscher. Als das Experiment misslang, ist er zuerst zu seinen Vorgesetzten gegangen — mit der Wahrheit. Er hat gestanden. Er hat gebeten, dass man es öffentlich macht und die Reparatur als Aufgabe der ganzen Velmar-Kaste annimmt.

**Velmar hat abgelehnt.** Zwei Gründe:
...
## 6. Portalmagie (neue Regel)

**Portalmagie braucht Druckmanipulation UND Zeitmanipulation.** Das ist die neue Regel, eingeführt in dieser Session. Sie hat mehrere Implikationen:

**Physikalisch:** Schwerkraft und Zeit sind dasselbe Phänomen (Einstein). Eine Quelle, die zwei Welten verbindet, ist im Prinzip ein Wurmloch — es braucht eine Verformung von Raum UND eine Verformung der Zeitachse. Jede Form der normalen Magie in Moragh ist **Raummanipulation** (Wasser fließt, Pflanzen wachsen, Feuer verbrennt, Stein bewegt sich, Licht bricht). Nur wenige Magier können zusätzlich Zeit manipulieren.

**Historisch:** Vor ~200 MZ-Jahren sind ~350 Menschen durch ein Quellenportal nach Thalassien geflohen. Keiner kam zurück. Die Geschichte ist bekannt — fast legendär. Danach wurde Portalmagie **von allen Fraktionen verboten**. Sie gilt als unkontrollierbar, gefährlich, religiös unrein. Das Verbot ist einer der wenigen Punkte, an dem Bund, Velmar und Thar sich einig sind.

**Wer kann Portale öffnen:**
- **Varen** — beherrscht Druckmanipulation (Velmar-Binder-Kaste) und hat sich Zeitmanipulation in 2 Jahren Portalforschung (MZ -3 bis -1) angeeignet. Seine ersten "Risse im Gefüge" sind brachial, unelegant, unsicher.
- **Vesper** — seine Resonanz ist Muster/Zeit. Schwerkraftmanipulation ist Zeitmanipulation — dieselbe physikalische Größe. Er kann implizit Zeit lesen und beeinflussen. Er ist der einzige der Vier Thalassier, der die Portalmagie intuitiv begreifen kann. (Das erklärt wie die Vier das Portal von Thalassien-Seite öffnen: Vespers Zeit-Resonanz liefert die zweite Komponente. Ohne ihn geht es nicht.)
- **Elke** — ihre Resonanz ist Erde/Stein. Das ist reine Raummanipulation. Sie kann KEIN Portal öffnen. Sie ist durch Varens Portal gekommen, auf Varens Einladung, nicht aus eigener Kraft. **Das ist ein Teil ihrer Geheimnis-Bürde:** ihr Weg nach Moragh war ein Geschenk an sie, kein eigener Akt. Sie ist abhängig.
- **Die 350 Verschwundenen vor 200 MZ-Jahren:** müssen mindestens einen Zeit-Begabten dabei gehabt haben. Canon-Hypothese: Der Zeit-Begabte ist auf der anderen Seite (Thalassien) gestorben, bevor jemand den Rückweg lernen konnte. Deshalb kam niemand zurück. Deshalb ist Portalmagie als "einweg" und "letal" in Moragh-Folklore eingebrannt.

**Marens Rückweg (Buch 2) — das Problem und die Lösung:**
Maren ist Wasser/Fluss — Raummanipulation, nicht Zeit. Nach der Regel kann sie **kein** Portal öffnen. Trotzdem soll sie in Buch 2 allein von Moragh nach Thalassien zurückgehen.

**Lösung (offen, braucht Entscheidung):**
- **Option A:** Wasser als Strömung enthält Zeit implizit (flow rate = Zeitableitung). Maren hat eine Hintertür über ihre Resonanz. **Weicht die Regel.**
- **Option B:** Vesper öffnet das Portal für sie und bleibt selbst — sein Opfer. Er reißt seinen eigenen Rückweg zu, damit sie gehen kann. **Stärkster emotionaler Moment** für Vesper+Maren-Trennung.
- **Option C:** Maren altert Jahrzehnte im Durchgang, weil sie die Zeit-Komponente mit eigener Lebenszeit bezahlt. Passt zur Zeitdilatation. Erklärt warum sie in Thalassien als alte Frau stirbt. **Dramatisch bitter.**
- **Empfehlung (unsere Diskussion):** Option B oder C — beide wurden nicht abschließend entschieden.

---

## 7. Der Portalplan (MZ -3 bis Buch 1)

**MZ -3:** Varen beginnt die Portalforschung, 1 Jahr nach Kriegsbeginn. Er erkennt: die drei toten Quellen können mit Moragh-Magie allein nicht wiederbelebt werden. Moragh-Magie kommt AUS den Quellen — man kann einen trockenen Brunnen nicht mit Wasser aus dem Nachbarbrunnen füllen. Das System ist geschlossen.

**Was er sucht:** Eine externe Energiequelle. Etwas, das nicht aus den bestehenden Moragh-Quellen kommt. Zuerst denkt er an andere Welten — rein theoretisch, als Gedankenexperiment. Dann erinnert er sich an die 350 Verschwundenen. Und an das Verbot der Portalmagie.

**MZ -3 bis MZ -1:** Zwei Jahre Forschung im Geheimen. Brachiale Versuche. Erste Risse im Gefüge. Er lernt Zeitmanipulation über Umwege — über Schwerkraftmanipulation, die er aus der Druckforschung bereits kennt. Die beiden Felder sind dasselbe. Er wird besser. Er wird präziser.

**MZ -1 (= TZ 154):** Elkes Zeit. Elke kommt durch einen **ungeplanten** Riss — einen von Varens brachialen Versuchen. Er schickt drei Feuer-Schemen durch, um zu sehen ob etwas hinkommt. Elke wird unbeabsichtigt mitgerissen. Sie kommt in Moragh an. Varen kappt die Schemen-Bindung, als er sie sieht. Er erkennt sofort: **da drüben wohnen Menschen.** Und: **die Zeit läuft dort anders.**
...
**MZ -0.42 (= TZ 354, wenige Wochen nach Elke):** Varen plant die Rückholung der Vier aktiv. Bereitet Agenten vor. Schickt Haron Dahl zuerst durch — MZ -0.17 = TZ 485 in Thalassien. Dann die anderen Agenten: Uhrmacher (Vesper-Köder), Artikel-Verfasser (Alphina-Köder), Platten-Fälscher (Sorel-Köder). Für Varen vergehen Wochen zwischen jedem Agenten-Durchgang. Für die Agenten vergehen Jahrzehnte in Thalassien. Sie leben ganze Leben, bauen Köder, warten auf die Resonanz-Begabten. Haron stirbt an Alter und Schwerkraft (0.7g auf 1g zurückzukehren ist tödlich), nachdem er sein Werk getan hat.

**Tschechow-Saat:** Die Tatsache, dass Varen brachiale erste Versuche gemacht hat, bevor er Elke traf, erklärt warum die ersten Jahre der Portalforschung gefährlich und unkontrolliert waren. Elkes "Ankunft" als Unfall beweist, dass er damals noch nicht präzise war. Später wird er präzise — deshalb funktioniert das Ritual der Vier wie geplant.
...
## 12. Cross-References und offene Fragen

**Wo dieses Dossier cross-referenziert:**
- `00-welt.md` — Abschnitt "Varen" aktualisiert, Abschnitt "Varens Schuld" aktualisiert, Sorels-Tod-Szene aktualisiert mit Farbpalette
- `00-storyline.md` — Varens Kurz-Biografie aktualisiert, Buch-2-Alphinas-Bogen komplett umgeschrieben, Farbpalette als Trilogie-Tschechow
- `00-canon-kompakt.md` — Varen-Zeile aktualisiert
- `pov/alphina.md` — Zorn-Farbpalette hinzugefügt
...
**Dieses Dossier ist der Primärreferenz für alle zukünftigen Entwürfe und Ausarbeitungen, die Varen, Alphinas Buch-2-Bogen, die Sorel-Todesszene oder die Farblogik betreffen. Bei Konflikt mit älteren Notizen oder mit anderen Canon-Files gewinnt dieses File, da es den aktuellsten Stand der Autor-Entscheidungen dokumentiert.**

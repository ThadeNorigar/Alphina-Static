...
**Visionärisch-kalt.** Sie glaubt, dass Thalassien nur überleben kann, wenn es sich Moragh **aneignet** — Quellen, Magie-Wissen, Rohstoffe. Maren hat nach Syras Einschätzung „zu sanft" gearbeitet, was 2037 mit dem Tod der Expedition 1 endete. Syra ist bereit, den Preis zu zahlen, den Maren nicht zahlen wollte.

**Kein Hass, keine Ideologie.** Nur ein Institut, das Maßstäbe setzt. Ihre Mitarbeiter:innen respektieren sie, lieben sie nicht. Anti-Pol zu Drael (höflich-warm-manipulativ) und zu Varen (charmant-pathologisch) — Syras Antagonismus läuft durch Pragmatik und Resonanz-Modulator-Effizienz.

**Marens Doktrin als zu sanft.** Sie kippt das Institut, das Marens Namen trägt, gegen Marens Werte. Eine intellektuelle Patrizid-Linie. Sie weiß: jede neue Expedition geht durch ein Tor, das eine Frau gebaut hat, die sie für naiv hält.

**Wissenschaft als Eroberung.** Resonanz-Modulator (hält Portal 72 Stunden offen) ist ihre persönliche Erfindung. Sie testet ihn jahrelang vor 2120. Wissenschafts-Ethos minus Ethik = Werkzeug.

**Verräter-Vorwurf gegen Tyra.** Sie weiß von Tyra durch historische Expedition-1-Berichte. Sie hält Tyra für eine **Verräterin** — eine Halvard auf der falschen Seite. Sie hat Tyra nie getroffen, kann sie nicht hören, hasst nur ihren Namen in den Akten.

**Überlebt das Finale, ihre Vision nicht.** Stirbt nicht im Krieg — sie ist in Thalassien, das Institut ist blind, der Modulator tot. **Erschöpfung, nicht Tragödie.** Sie ist die Frau, die ihre Lebensarbeit ins Bodenlose sieht — und nicht weiß, was sie morgens noch tun soll.

---

## Aussehen

- Ende fünfzig bis Anfang sechzig (je nach Akt)
- Silbergraues Haar, kurz geschnitten, militärisch ordentlich
- Subtile Bodymods: Neural-Interface-Port hinter dem rechten Ohr, Augen mit leichtem Iris-Ring (optisches Implantat für Datenüberlagerung)
- Thalassisch gebaut, aber hager durch Arbeit
- Kleidung: dunkle Institutsroben, hochgeschlossen, keine Zierde
- Stimme trocken, präzise, nie erhoben
...
**Varen — Spiegel auf der anderen Seite:** Sie kennt seinen Namen aus Expedition-Aufklärungs-Berichten. Sie weiß nichts von seiner Velmar-Position oder seiner Halsband-Mechanik. Wenn sie ihn kennen würde, würde sie ihn als Werkzeug rekrutieren wollen.

**Mitarbeiter:innen am Institut:** Respekt, keine Liebe. Sie führt durch Effizienz, nicht durch Charme. Niemand kündigt, niemand jubelt.

---

## Narrative Funktion

Syra ist die **Thalassien-Antagonistin**. Varen ist der Moragh-Antagonist. Beide intelligent, beide glauben an ihre Vision, beide sind Brücken-Menschen, die aus Angst vor Kontrollverlust grausam werden.

In Interludien (I9 + I14) erscheint sie als POV — die Leserin erfährt, wie in der Zukunft Thalassien über Moragh denkt, ohne dass die Vier das in Moragh wissen.

---

## Verworfen-Sektion

**Syra reist persönlich nach Moragh (gestrichen 2026-04):** Frühere Version hatte Syra in der Expedition 2 mit Kelvar reisen. **Verworfen** — sie bleibt in Thalassien, koordiniert von Vael. Macht-Halterinnen schicken Heere, sie reisen nicht selbst.

...
- Er wohnt und arbeitet im Keller des Lichthausses in Vael, sechs Wochen plus.
...
**Nicht gewusst:** Was der Hügel ist (er sagt "die sieben Steine" oder "der Hügel", nicht "Steinkreis"). Warum sein Gesicht auf alten Platten erscheint. **Dass er selbst es ist, der die Projektionen auf den Platten erzeugt.** Vespers Namen oder Existenz. Henrik als Person (nur Marktgerücht). Alphinas konkrete Pflanzen-Resonanz — er hat nur die Heilung an seiner Hand gesehen, nichts über Farne, Wurzeln oder den langsameren Modus.

## Aktive Tschechow-Waffen

- Die zerbrochene Platte aus Falkensand (13 Jahre alt, in der Schublade, nie weggeworfen).
...
- **Licht-Resonanz kompensiert die Energie-Dämpfung** (B1-K38) — Varen hält die Vier mit Druck (festhalten) + Zeit (verlangsamen) + Energie (Resonanz dämpfen). Sorels unbewusst aktive Licht-Resonanz hebt die Energie-Dämpfung an seinem Körper lokal auf — er ist der einzige, der sich bewegen kann. Trigger seiner Hingabe-Bewegung („Nimm die Hand weg.").
- **Sterbe-Mechanik: Lichtsäule aus dem eigenen Leben** (B1-K38) — als Varens umgelenkter Energie-Druck Sorels instabile Resonanz erreicht, reißt sie aus ihm: Bilder seines Lebens (Alphina im Garten, Verband, Platte, Vater, Grauwe) werden in Millisekunden als Licht freigesetzt. Sein untrainierter Körper hält es nicht aus — die Resonanz zerreißt ihn von innen. Der Energie-Druck sollte fixieren, nicht töten; Sorel stirbt an seiner eigenen ungeordneten Magie. Diese Trennung (Auslöser ≠ Ursache) gibt Varen die Argumentations-Lücke für seinen Abgangstext.
...
**Alphina:** Erstbegegnung in Kap 12, Botanischer Garten bei Nacht. Sie rief dreimal, bevor er antwortete. Sie stand, als er hervortrat, und bewegte sich nicht nach hinten — ein Gewicht, das er bei Frauen dreimal in seinem Leben gesehen hat, einmal bei seiner Mutter. Sie hat ihn ohne Vorwarnung an der verletzten Hand berührt und ihre Magie an ihm erprobt. Er hat es zugelassen. Er ist der Einzige, bei dem ihre Kontrolle nicht auf gewohnte Art greift — sein Nicht-Antworten ist keine Verweigerung, sondern ein Zuhören, das nichts vereinfachen will. Sie dominiert; er hat Grenzen. Er schweigt über die Platte. Emotionaler Kern des Buchs.

**Vesper:** Noch nicht direkt begegnet (Stand Kap 12). Kennt den Namen nicht.

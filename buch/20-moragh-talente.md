# Moragh-Magie — Talente und Bürger-Regeln

**Letzte Aktualisierung:** 2026-04-19
**Status:** Aktiver Kanon. Ergänzt `10-magie-system.md` um die Regelsysteme für Moragh-Bürger (Nicht-Thalassier).
**Verwandte Files:** `10-magie-system.md` (Kern-Magie, Thalassier, Welt-Physik), `21-moragh-gesellschaft.md` (Fraktionen), `22-moragh-figuren.md` (Nebenfiguren).
...
## Alterskurve (95 % der Bevölkerung)

| Alter | Einzelbegabt | Dualbegabt | Tripel+ |
|---|---|---|---|
| 11–15 (Pubertät) | Stufe 0–1 | Stufe 0–1 | Stufe 0–1 |
| 15–25 | Stufe 1–2 | beide 1, eine 2 | alle 1 |
| 25–35 | Stufe 3 | 2/2 oder 3/1 | 2/1/1 |
...
Jede Person hat ein **Grundbudget** zwischen 4 und 8 Punkten (Stärke), das nach oben skaliert mit **+2 pro zusätzlichem Talent**. Trainingszeit verteilt die Punkte auf die Talente — ein Dualist kann auch 8+1 fahren und quasi wie ein Spezialist wirken.

| Profil | Grundbudget | Mit Talent-Bonus | Typische Verteilungen |
|---|---|---|---|
| Spezialist (1 Talent) | 4–8 | 4–8 | 5 · 7 · 8 (Ausreißer) |
| Dualist (2) | 4–8 | 6–10 | 5+3 · 7+2 · 4+4 · 8+1 |
| Tripel (3) | 4–8 | 8–12 | 4+4+3 · 6+3+2 · 5+4+2 |
| Quad (4) | 4–8 | 10–14 | 4+4+3+2 · 6+3+3+1 |
| Fünffach (5) | 4–8 | 12–16 | 4+3+3+3+2 · 6+4+3+2+1 |

**Beispiel Bäcker:** Tripelbegabt mit **Telekinese 3** (Teig kneten aus Distanz), **Zeit 2** (Gehen beschleunigen, Ruhephase steuern), **Feuer 2** (Ofen einheizen). Budget 7, alltagsnah, nicht außergewöhnlich.

## Bevölkerungsverteilung

| Profil | Anteil | Praktisch |
|---|---|---|
| Spezialisten | 45 % | Erreichen am ehesten Stufe 6+ in ihrem Feld, spezialisierte Berufe |
| Dualisten | 30 % | Flexibler Alltag, mittlere Stärke in zwei Feldern |
| Tripelbegabte | 20 % | Breit einsetzbar, selten stark in einem Einzelfeld |
...
## Rituale — die Ausnahme vom Reichweiten-Verfall
...
- **Ritual-Zeit ist lang** — Aufbau mit Vorbereitung, Koordination, oft Ortsbezug zu einer Quelle. Nicht spontan einsetzbar.
- **Ritual-Kosten sind hoch** — alle Teilnehmer zahlen mit Erschöpfung, auch bei Thalassiern üblich mit Regenerationsbedarf.
...
| Kategorie | Talente |
|---|---|
| Beschwörung | Schemen rufen · Schemen binden (nur Sekundär bei Rufern) |
| Klassische Elemente | Feuer · Wasser · Luft · Erde · Stein |
...
| 5 | Stein glüht in Hand — eigene Haut unversehrt |
| 6 | Hitze aus Raum entziehen, Zimmer friert |
| 7 | Flammen werfen und formen (Bogen, Peitsche, Kugel) |
| 8 | Ohne Ofen schmieden, Legierungen in Handflächen-Schmelztiegel |
| 9 | Magitech-Bestie von außen aufschmelzen |
| 10 | Feuersturm bis ~100 m · Fleisch eines Feindes von innen entzünden |

### Wasser (inkl. aller Aggregatzustände)

| Stufe | Fähigkeit |
|---|---|
| 1 | Teetasse kräuselt, Pfütze glättet |
| 2 | Wasser minimal wärmer/kühler |
| 3 | Wasseroberfläche formen, Regen weicht aus |
| 4 | Fluss stoppen, Strömung umlenken |
| 5 | Wasser in der Luft halten (Schild, Wand, Faust) |
| 6 | Wasserwand aufrichten und gefrieren — Eisschild |
| 7 | Heilung: Gewebewasser verschiebt, Blutung stoppt |
| 8 | Flutwelle, fremdes Blut außerhalb des Körpers lenken, kochen/frieren setzen |
| 9 | Wassersäule in überhitzten Dampf explodieren |
| 10 | Blut im lebenden Körper gefrieren oder kochen |

### Luft

| Stufe | Fähigkeit |
|---|---|
| 1 | Zugluft in geschlossenem Raum |
...
### Erde (Lehm, Boden, lockeres Gestein)

| Stufe | Fähigkeit |
|---|---|
| 1 | Sandkörner rieseln |
| 2 | Handvoll Erde formen |
| 3 | Lehmziegel aus Boden ziehen |
| 4 | Menschen-großes Loch graben in Minuten |
| 5 | Hügel aufwerfen |
| 6 | Schlucht öffnen, Graben anlegen |
| 7 | Erdrutsch auslösen |
...
|---|---|
| 1 | Kiesel glätten |
| 2 | Stein mit Hand wie Ton formen (Druckkontakt) |
| 3 | Basaltziegel ziehen |
| 4 | Steinmauer formen |
| 5 | Treppe aus Fels schneiden |
| 6 | Haus aus nacktem Fels ziehen |
| 7 | Steinbrücke in Stunden |
| 8 | Turm aus Gestein |
| 9 | Festung, komplexe Architektur |
| 10 | Felsmassiv versetzen |

### Metall

| Stufe | Fähigkeit |
|---|---|
| 1 | Eisenspäne bewegen |
| 2 | Nagel krümmen |
...
|---|---|
| 1 | Splitter bewegen |
| 2 | Ast biegen ohne Bruch |
| 3 | Holzscheibe glätten |
| 4 | Balken aus rohem Stamm formen |
| 5 | Dachstuhl ohne Nägel oder Werkzeug |
...
| Stufe | Fähigkeit |
|---|---|
| 1 | Glasscherbe erwärmen, Kante glätten |
| 2 | Kleines Objekt aus Glas formen (Perle, Tropfen) |
| 3 | Becher, Flasche, einfache Gefäße gießen |
| 4 | Linse schleifen ohne Werkzeug |
| 5 | Kristall zur Resonanz stimmen |
| 6 | Buntglasfenster ziehen |
| 7 | Kristall als Resonanzverstärker für andere Talente |
| 8 | Spiegel-System für Licht-Begabte |
| 9 | Glashülle um ganzes Gebäude |
| 10 | Kristall-Schrein, der Quellen-Energie zwischenspeichert |

### Telekinese

| Stufe | Fähigkeit |
|---|---|
| 1 | Nahfeld 50 cm, bis 5 kg — Teller schieben, Feder heben |
| 2 | 1 m, bis 10 kg — Schüssel heben, Regal-Gegenstände holen |
| 3 | 3 m, bis 30 kg — Teig kneten aus Distanz, Koffer tragen |
| 4 | 10 m, Türen aus Angeln heben |
...
| Stufe | Fähigkeit |
|---|---|
| 1 | Flöten-Ton ohne Instrument (leise) |
| 2 | Stimme leicht verstärken (Predigt ohne Heiserkeit) |
| 3 | Töne formen — Musik ohne Instrument |
| 4 | Geräusche dämpfen (Flüsterzone um zwei Personen) |
| 5 | Raum-Akustik neu formen |
| 6 | Schallwaffe — Ohrenschmerz bei Feinden |
| 7 | Stimme über Stadt tragen |
| 8 | Glas zersingen, Gestein zerrütten durch Frequenz |
| 9 | Menschen dauerhaft taub machen |
| 10 | Gebäude per Schallresonanz zum Einsturz bringen |

### Elektrizität

| Stufe | Fähigkeit |
|---|---|
| 1 | Statik in Haaren, Knistern an Metall |
| 2 | Kleiner Funke aus Fingerspitze |
| 3 | Kerze mit Funke entzünden |
| 4 | Leiter bedienen (Thar-Magitech-Grundlage) |
| 5 | Kleinen Resonanz-Generator speisen |
| 6 | Gelähmten durch Schock kurzfristig mobilisieren |
| 7 | Blitz in Handfläche sammeln |
| 8 | Blitz werfen (10 m) |
| 9 | Magitech-Großanlage speisen, Maschinen aktivieren |
| 10 | Gewitter-Entladung, Straßenzug treffen |
...
| 8 | Durch fremde Augen sehen (Blickkontakt) | Kopplung |
...
| 4 | Metall rostet sichtbar in Minuten |
| 5 | Holzbalken altert zehn Jahre in einer Stunde |
| 6 | Pflanze durchläuft Lebenszyklus in Sekunden |
...
| Stufe | Fähigkeit |
|---|---|
| 1 | Luft vor den Füßen leichter fühlen |
| 2 | Buch schwerer/leichter erscheinen lassen |
| 3 | Gegenstand tatsächlich schwerer (doppelt) |
| 4 | Mensch schwerer — kaum gehen |
| 5 | Raumdruck verändern (Ohrendruck wie im Berg) |
| 6 | Objekt im freien Fall abbremsen |
| 7 | Mauer durch Druckwelle stürzen |
| 8 | Portal-Teilverformung (Varens Forschungsfeld) |
| 9 | Zielbereich mit Schwerkraft zusammenpressen |
| 10 | Portalmagie (zusammen mit Zeit-Begabtem) |

### Pflanzen/Flora (nur aufbauend)

| Stufe | Fähigkeit |
|---|---|
| 1 | Samen keimt Stunden früher |
| 2 | Moos in Fugen über Nacht |
| 3 | Setzling zum Pflänzchen in Tagen |
| 4 | Kletterpflanze an Mauer hoch in einer Nacht |
| 5 | Baum über Nacht, mannshoch |
| 6 | Hain in Wochen, durchwurzelt Pflaster |
| 7 | Wald in Stunden (sofern Sporen/Samen vor Ort) |
| 8 | Wurzeln durchziehen ganzes Dorf (Gebäude knicken — kein Töten, indirekter Schaden) |
| 9 | Pflanzendecke über Landstriche |
| 10 | Quelle mit Wachstumsenergie überladen (Kettenreaktion, Finale-Waffe) |

**Braucht lebendes Ausgangsmaterial** — Samen, Sporen, Mikroben im Boden. Kein Wachstum aus totem Stein oder poliertem Glas. **Kein Welken, kein Absterben — nur Wachsen.**

### Heilung/Gewebe (nur aufbauend)

| Stufe | Fähigkeit |
|---|---|
| 1 | Blauer Fleck verblasst doppelt so schnell |
| 2 | Schnitt schließt in Minuten |
| 3 | Fieber sinkt, Infektion klingt ab |
| 4 | Knochenbruch in Stunden, glatt |
| 5 | Verbrennung vernarbt sauber, Sehnen regenerieren |
| 6 | Innere Blutung gestoppt, Organ regeneriert |
| 7 | Rückenmark, Nervenschaden — Lähmung verschwindet |
| 8 | Gliedmaße wächst über Tage nach |
| 9 | Klinisch Toten zurückholen (bis ~5 Min nach Tod) |
| 10 | Mehrere Schwerverletzte gleichzeitig |
...
| Stufe | Fähigkeit |
|---|---|
| 1 | Glas Wasser kühlt schneller |
| 2 | Pfütze gefriert unter der Hand |
| 3 | Kleines Eisstück formen |
| 4 | Eiszapfen aus Luftfeuchtigkeit |
| 5 | Fenster vereisen in Sekunden |
| 6 | Feind erleidet Frostbiss (Finger taub, Haut erfriert) |
| 7 | Boden flächig vereisen (Glatteis) |
| 8 | Eismauer errichten |
| 9 | Raum in Frost versetzen, Menschen erfrieren |
| 10 | Eiskäfig um Feind, Atem gefriert in Lunge |

**Unterschied zu Wasser:** Eis-Begabte können keine flüssige Bewegung, nur Kälte und Gefrieren. Wasser-Begabte mit Stufe 6+ können Eis als Untermenge.
...
| Stufe | Fähigkeit |
|---|---|
| 1 | Bindungs-Skizze, hält eine Stunde |
| 2 | Kleiner Schemen, Wochen gebunden |
| 3 | Monate gebunden |
| 4 | Jahre gebunden |
| 5 | Bindung überlebt Reisen über große Distanzen |
| 6 | Zwei Schemen gleichzeitig gebunden |
| 7 | Humanoider Schemen mit Persönlichkeits-Schulung |
| 8 | Fünf Schemen gleichzeitig, komplex |
| 9 | Bindung über Generationen vererbbar (Velmar-Tradition) |
| 10 | Dutzende gebunden, **Bund zweiter Ordnung** mit sprechendem, individualisiertem Schemen (Velmar-Rechtsform) |

---

## Kombinations-Grundregel

Zwei oder mehr Begabte können ihre Talente koppeln. Wirkung = Summe plus Synergie-Bonus je nach Kompatibilität.

**Beispiele Zweier-Kombinationen** (für Moragh-Bürger im Alltag):
- Pflanzen + Wasser: Gartenbau. Üblich. Paar-Arbeit in jedem Moragh-Gehöft.
- Feuer + Metall: Schmiede-Rituale. Zwei Personen formen zusammen, was einer allein nicht schafft.
- Stein + Holz: Hausbau. Standardkombination.
- Rufen + Binden: Velmar-Standardbeschwörung. Zeitgleich — der Rufer zieht, der Binder hält.

**Thalassier-spezifische Kombinationen** der Fünf (Alphina/Sorel/Vesper/Maren/Runa) siehe `10-magie-system.md`, Abschnitt *Kombinations-Matrix*.
